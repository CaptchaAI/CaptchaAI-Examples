...
**[Building Custom CaptchaAI Alerts with PagerDuty](https://blog.captchaai.com/captchaai-alerts-pagerduty-integration)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-alerts-pagerduty-integration
   ```
