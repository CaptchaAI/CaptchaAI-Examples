# CaptchaAI Extension: What Data It Sees and What It Sends
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-privacy-data-handling
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-privacy-data-handling/` directory (not inside a language folder)
