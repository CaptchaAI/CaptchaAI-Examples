# Solving CAPTCHAs Inside browser-use Agent Workflows
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captcha-with-browser-use-agent
   ```
...
- Make sure `.env` file is in the `articles/solving-captcha-with-browser-use-agent/` directory (not inside a language folder)
