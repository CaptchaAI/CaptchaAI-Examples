...
**[Build a CAPTCHA Solving Microservice with FastAPI and CaptchaAI](https://blog.captchaai.com/fastapi-captchaai-microservice)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/fastapi-captchaai-microservice
   ```
