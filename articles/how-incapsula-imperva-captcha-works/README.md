# How Incapsula (Imperva) CAPTCHA Works
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-incapsula-imperva-captcha-works
   ```
...
- Make sure `.env` file is in the `articles/how-incapsula-imperva-captcha-works/` directory (not inside a language folder)
