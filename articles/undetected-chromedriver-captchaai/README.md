...
**[Undetected ChromeDriver with CaptchaAI Integration](https://blog.captchaai.com/undetected-chromedriver-captchaai)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/undetected-chromedriver-captchaai
   ```
