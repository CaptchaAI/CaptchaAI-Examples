# How the CaptchaAI Extension Injects Solved Tokens (Content Script Walkthrough)
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-content-script-injection-explained
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-content-script-injection-explained/` directory (not inside a language folder)
