# Solving CAPTCHAs Inside Azure Durable Functions
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-azure-durable-functions
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-azure-durable-functions/` directory (not inside a language folder)
