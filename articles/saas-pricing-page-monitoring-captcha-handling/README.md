# SaaS Pricing-Page Monitoring With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/saas-pricing-page-monitoring-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/saas-pricing-page-monitoring-captcha-handling/` directory (not inside a language folder)
