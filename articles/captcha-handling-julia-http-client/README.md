# Solving CAPTCHAs from a Julia HTTP Client
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-julia-http-client
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-julia-http-client/` directory (not inside a language folder)
