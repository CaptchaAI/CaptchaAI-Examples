# Cloud Hosting Pricing Monitoring With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/cloud-hosting-pricing-monitoring-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/cloud-hosting-pricing-monitoring-captcha-handling/` directory (not inside a language folder)
