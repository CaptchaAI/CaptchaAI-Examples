# Building a Fast CaptchaAI Client on the Bun Runtime
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-bun-runtime-fast-solver-client
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-bun-runtime-fast-solver-client/` directory (not inside a language folder)
