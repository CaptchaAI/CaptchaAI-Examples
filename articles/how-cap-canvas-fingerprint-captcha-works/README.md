# How Canvas-Fingerprint CAPTCHAs Work
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-cap-canvas-fingerprint-captcha-works
   ```
...
- Make sure `.env` file is in the `articles/how-cap-canvas-fingerprint-captcha-works/` directory (not inside a language folder)
