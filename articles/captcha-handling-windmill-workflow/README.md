# Adding a CaptchaAI Step in a Windmill Workflow
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-windmill-workflow
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-windmill-workflow/` directory (not inside a language folder)
