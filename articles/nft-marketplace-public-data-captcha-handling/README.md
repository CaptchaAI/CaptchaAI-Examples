# NFT Marketplace Public-Data Pulls With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/nft-marketplace-public-data-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/nft-marketplace-public-data-captcha-handling/` directory (not inside a language folder)
