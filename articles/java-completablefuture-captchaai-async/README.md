...
**[Java CompletableFuture + CaptchaAI: Async CAPTCHA Pipeline](https://blog.captchaai.com/java-completablefuture-captchaai-async)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/java-completablefuture-captchaai-async
   ```
