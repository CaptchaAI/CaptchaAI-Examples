# CaptchaAI Extension + Undetected ChromeDriver: Working Setup
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-with-selenium-undetected-chromedriver
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-with-selenium-undetected-chromedriver/` directory (not inside a language folder)
