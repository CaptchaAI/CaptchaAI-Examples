...
**[Solve GeeTest v3 CAPTCHA with Python and CaptchaAI](https://blog.captchaai.com/solve-geetest-v3-python)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solve-geetest-v3-python
   ```
