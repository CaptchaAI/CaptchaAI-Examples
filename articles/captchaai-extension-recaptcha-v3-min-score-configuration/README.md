# Configuring the reCAPTCHA v3 Minimum Score in the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-recaptcha-v3-min-score-configuration
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-recaptcha-v3-min-score-configuration/` directory (not inside a language folder)
