# Solving CAPTCHAs Inside a Fiber Go Server
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-fiber-go-server
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-fiber-go-server/` directory (not inside a language folder)
