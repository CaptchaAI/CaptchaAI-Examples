# Redis for CAPTCHA Token TTL Management and Caching
...
**[Redis for CAPTCHA Token TTL Management and Caching](https://blog.captchaai.com/redis-captcha-token-ttl-management)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/redis-captcha-token-ttl-management
   ```
