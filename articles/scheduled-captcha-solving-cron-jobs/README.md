...
**[Scheduled CAPTCHA Solving: Cron Jobs and Task Schedulers](https://blog.captchaai.com/scheduled-captcha-solving-cron-jobs)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/scheduled-captcha-solving-cron-jobs
   ```
