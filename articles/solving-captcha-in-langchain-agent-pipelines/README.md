# Solving CAPTCHAs Inside LangChain Agent Pipelines
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captcha-in-langchain-agent-pipelines
   ```
...
- Make sure `.env` file is in the `articles/solving-captcha-in-langchain-agent-pipelines/` directory (not inside a language folder)
