# Pairing CaptchaAI With Firebase Auth reCAPTCHA
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-firebase-auth-recaptcha
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-firebase-auth-recaptcha/` directory (not inside a language folder)
