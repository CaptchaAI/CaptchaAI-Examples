...
**[BLS CAPTCHA: Understanding Instructions Codes and Solving](https://blog.captchaai.com/bls-captcha-instructions-code-solving)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/bls-captcha-instructions-code-solving
   ```
