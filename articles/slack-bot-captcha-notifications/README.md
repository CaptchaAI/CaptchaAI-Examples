...
**[Slack Bot Notifications for CAPTCHA Events](https://blog.captchaai.com/slack-bot-captcha-notifications)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/slack-bot-captcha-notifications
   ```
