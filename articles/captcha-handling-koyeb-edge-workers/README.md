# Solving CAPTCHAs With Koyeb Edge Workers
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-koyeb-edge-workers
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-koyeb-edge-workers/` directory (not inside a language folder)
