...
**[Solving CAPTCHAs on Chinese Websites with CaptchaAI](https://blog.captchaai.com/solving-captchas-chinese-websites)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captchas-chinese-websites
   ```
