# The CaptchaAI Extension Solved It But the Site Still Blocked Me — Why
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-rate-limited-by-target-site
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-rate-limited-by-target-site/` directory (not inside a language folder)
