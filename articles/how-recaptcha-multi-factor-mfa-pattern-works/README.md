# How the reCAPTCHA Multi-Factor (MFA) Pattern Works
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-recaptcha-multi-factor-mfa-pattern-works
   ```
...
- Make sure `.env` file is in the `articles/how-recaptcha-multi-factor-mfa-pattern-works/` directory (not inside a language folder)
