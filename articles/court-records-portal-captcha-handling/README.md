# Court Records Portal CAPTCHA Handling for Legal Research
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/court-records-portal-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/court-records-portal-captcha-handling/` directory (not inside a language folder)
