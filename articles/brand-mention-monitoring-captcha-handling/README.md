# Brand Mention Monitoring With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/brand-mention-monitoring-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/brand-mention-monitoring-captcha-handling/` directory (not inside a language folder)
