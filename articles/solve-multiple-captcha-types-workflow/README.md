...
**[How to Solve Multiple CAPTCHA Types in One Workflow](https://blog.captchaai.com/solve-multiple-captcha-types-workflow)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solve-multiple-captcha-types-workflow
   ```
