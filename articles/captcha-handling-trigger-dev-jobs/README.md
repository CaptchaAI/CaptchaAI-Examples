# Calling CaptchaAI From a Trigger.dev v3 Job
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-trigger-dev-jobs
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-trigger-dev-jobs/` directory (not inside a language folder)
