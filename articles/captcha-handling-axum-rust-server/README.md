# Solving CAPTCHAs Inside an Axum Rust Server
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-axum-rust-server
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-axum-rust-server/` directory (not inside a language folder)
