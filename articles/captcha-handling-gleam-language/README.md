# Solving CAPTCHAs from Gleam (BEAM Type-Safe)
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-gleam-language
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-gleam-language/` directory (not inside a language folder)
