...
**[CAPTCHA Handling for Sports Statistics Data Collection](https://blog.captchaai.com/sports-statistics-data-captcha-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/sports-statistics-data-captcha-handling
   ```
