# Solving CAPTCHAs from a Nim HTTP Client
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-nim-language
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-nim-language/` directory (not inside a language folder)
