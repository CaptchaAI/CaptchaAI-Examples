# Get Free Threads Inside the CaptchaAI Extension to Test It
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-free-trial-threads-guide
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-free-trial-threads-guide/` directory (not inside a language folder)
