...
**[CAPTCHA Handling for Flight Status Monitoring](https://blog.captchaai.com/flight-status-monitoring-captcha-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/flight-status-monitoring-captcha-handling
   ```
