# Extension Troubleshooting: reCAPTCHA Grid Not Solving
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-troubleshoot-recaptcha-grid
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-troubleshoot-recaptcha-grid/` directory (not inside a language folder)
