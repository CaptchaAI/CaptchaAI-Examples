...
**[Power Automate + CaptchaAI: Microsoft Flow CAPTCHA Solving](https://blog.captchaai.com/power-automate-captchaai-captcha-solving)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/power-automate-captchaai-captcha-solving
   ```
