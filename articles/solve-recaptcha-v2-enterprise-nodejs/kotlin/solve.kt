...
fun main() {
    ...
    val submitParams = "key=${URLEncoder.encode(apiKey, enc)}&method=userrecaptcha&googlekey=${URLEncoder.encode(googlekey, enc)}&pageurl=${URLEncoder.encode(pageurl, enc)}&enterprise=1&json=1"
