...
**[How to Solve reCAPTCHA v2 Enterprise with Node.js](https://blog.captchaai.com/solve-recaptcha-v2-enterprise-nodejs)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solve-recaptcha-v2-enterprise-nodejs
   ```
