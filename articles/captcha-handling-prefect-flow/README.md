# Calling CaptchaAI From a Prefect Flow
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-prefect-flow
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-prefect-flow/` directory (not inside a language folder)
