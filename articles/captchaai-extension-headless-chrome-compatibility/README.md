# Using the CaptchaAI Extension with Headless Chrome
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-headless-chrome-compatibility
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-headless-chrome-compatibility/` directory (not inside a language folder)
