# Loading CaptchaAI Keys via Bitwarden Secrets Manager
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/security-bitwarden-secrets-manager-captchaai
   ```
...
- Make sure `.env` file is in the `articles/security-bitwarden-secrets-manager-captchaai/` directory (not inside a language folder)
