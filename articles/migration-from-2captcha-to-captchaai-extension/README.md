# Migrating From the 2Captcha Extension to the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/migration-from-2captcha-to-captchaai-extension
   ```
...
- Make sure `.env` file is in the `articles/migration-from-2captcha-to-captchaai-extension/` directory (not inside a language folder)
