...
**[Dynamic CAPTCHA Loading: Detecting Lazy-Loaded CAPTCHAs](https://blog.captchaai.com/dynamic-captcha-loading-lazy-loaded-detection)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/dynamic-captcha-loading-lazy-loaded-detection
   ```
