# Solving CAPTCHAs from an OCaml HTTP Client
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-ocaml-http-client
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-ocaml-http-client/` directory (not inside a language folder)
