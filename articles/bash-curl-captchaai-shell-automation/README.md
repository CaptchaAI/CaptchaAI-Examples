...
**[Bash Script + cURL + CaptchaAI: Shell CAPTCHA Automation](https://blog.captchaai.com/bash-curl-captchaai-shell-automation)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/bash-curl-captchaai-shell-automation
   ```
