...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-fastly-compute-edge
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-fastly-compute-edge/` directory (not inside a language folder)
