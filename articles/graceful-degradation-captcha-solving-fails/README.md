...
**[Graceful Degradation When CAPTCHA Solving Fails](https://blog.captchaai.com/graceful-degradation-captcha-solving-fails)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/graceful-degradation-captcha-solving-fails
   ```
