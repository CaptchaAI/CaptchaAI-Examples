# Solving CAPTCHAs Inside a Quarkus Microservice
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-quarkus-microservice
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-quarkus-microservice/` directory (not inside a language folder)
