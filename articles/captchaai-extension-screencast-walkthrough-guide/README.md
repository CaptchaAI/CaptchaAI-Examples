# Following the CaptchaAI Extension Screencast Walkthrough
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-screencast-walkthrough-guide
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-screencast-walkthrough-guide/` directory (not inside a language folder)
