# Building a Type-Safe CaptchaAI Pipeline with Effect TS
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-effect-ts-pipeline
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-effect-ts-pipeline/` directory (not inside a language folder)
