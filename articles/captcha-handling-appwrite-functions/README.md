...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-appwrite-functions
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-appwrite-functions/` directory (not inside a language folder)
