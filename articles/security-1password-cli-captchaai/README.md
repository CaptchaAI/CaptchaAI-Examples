# Loading CaptchaAI Keys via the 1Password CLI in Local Dev
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/security-1password-cli-captchaai
   ```
...
- Make sure `.env` file is in the `articles/security-1password-cli-captchaai/` directory (not inside a language folder)
