...
**[Solving GeeTest v3 with Node.js and CaptchaAI API](https://blog.captchaai.com/solving-geetest-v3-nodejs-captchaai)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-geetest-v3-nodejs-captchaai
   ```
