# CaptchaAI Extension vs Buster: Feature-by-Feature 2026
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-vs-buster-feature-by-feature
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-vs-buster-feature-by-feature/` directory (not inside a language folder)
