# Pinning the CaptchaAI Extension Version for Team Stability
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-version-pinning-team-stability
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-version-pinning-team-stability/` directory (not inside a language folder)
