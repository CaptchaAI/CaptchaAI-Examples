...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-bullmq-nodejs-queue
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-bullmq-nodejs-queue/` directory (not inside a language folder)
