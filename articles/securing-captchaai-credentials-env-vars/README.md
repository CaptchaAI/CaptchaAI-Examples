...
**[Securing CaptchaAI Credentials in Environment Variables](https://blog.captchaai.com/securing-captchaai-credentials-env-vars)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/securing-captchaai-credentials-env-vars
   ```
