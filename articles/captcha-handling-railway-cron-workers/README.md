# Solving CAPTCHAs With Railway Cron Workers
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-railway-cron-workers
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-railway-cron-workers/` directory (not inside a language folder)
