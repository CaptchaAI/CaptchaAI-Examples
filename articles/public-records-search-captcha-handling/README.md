# CAPTCHA Handling for Public Records Search Automation
...
**[CAPTCHA Handling for Public Records Search Automation](https://blog.captchaai.com/public-records-search-captcha-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/public-records-search-captcha-handling
   ```
...
1. **Submit** â€” Sends the CAPTCHA parameters to `https://ocr.captchaai.com/in.php` using method `base64`
