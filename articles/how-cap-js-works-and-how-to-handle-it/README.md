# How cap.js Works and How to Handle It
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-cap-js-works-and-how-to-handle-it
   ```
...
- Make sure `.env` file is in the `articles/how-cap-js-works-and-how-to-handle-it/` directory (not inside a language folder)
