...
**[Automated Login CAPTCHA Handling with CaptchaAI](https://blog.captchaai.com/automated-login-captcha-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/automated-login-captcha-handling
   ```
