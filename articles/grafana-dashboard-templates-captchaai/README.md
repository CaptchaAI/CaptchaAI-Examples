...
**[Grafana Dashboard Templates for CaptchaAI Metrics](https://blog.captchaai.com/grafana-dashboard-templates-captchaai)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/grafana-dashboard-templates-captchaai
   ```
