# Solving CAPTCHAs Inside a Spark Structured Streaming Job
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-spark-structured-streaming
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-spark-structured-streaming/` directory (not inside a language folder)
