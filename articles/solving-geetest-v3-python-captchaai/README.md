...
**[Solving GeeTest v3 with Python and CaptchaAI API](https://blog.captchaai.com/solving-geetest-v3-python-captchaai)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-geetest-v3-python-captchaai
   ```
