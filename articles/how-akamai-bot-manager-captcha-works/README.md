# How Akamai Bot Manager CAPTCHA Works
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-akamai-bot-manager-captcha-works
   ```
...
- Make sure `.env` file is in the `articles/how-akamai-bot-manager-captcha-works/` directory (not inside a language folder)
