# Using the CaptchaAI Extension to Speed Up Authorized BLS Booking Sessions
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-for-government-bls-bookings
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-for-government-bls-bookings/` directory (not inside a language folder)
