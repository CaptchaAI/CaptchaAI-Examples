# reCAPTCHA vs Turnstile vs hCaptcha vs ALTCHA: 2026 Matrix
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/recaptcha-vs-turnstile-vs-hcaptcha-vs-altcha-2026
   ```
...
- Make sure `.env` file is in the `articles/recaptcha-vs-turnstile-vs-hcaptcha-vs-altcha-2026/` directory (not inside a language folder)
