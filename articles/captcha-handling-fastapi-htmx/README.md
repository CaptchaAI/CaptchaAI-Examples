# Solving CAPTCHAs in FastAPI + HTMX Apps
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-fastapi-htmx
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-fastapi-htmx/` directory (not inside a language folder)
