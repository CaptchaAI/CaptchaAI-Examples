# Property Records Portal CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/property-records-portal-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/property-records-portal-captcha-handling/` directory (not inside a language folder)
