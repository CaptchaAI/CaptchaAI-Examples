...
**[Solve GeeTest v3 CAPTCHA with Node.js and CaptchaAI](https://blog.captchaai.com/solve-geetest-v3-nodejs)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solve-geetest-v3-nodejs
   ```
