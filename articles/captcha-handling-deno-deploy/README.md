# Solving CAPTCHAs From Deno Deploy
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-deno-deploy
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-deno-deploy/` directory (not inside a language folder)
