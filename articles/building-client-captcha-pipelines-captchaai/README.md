# Building Client CAPTCHA Pipelines with CaptchaAI
...
**[Building Client CAPTCHA Pipelines with CaptchaAI](https://blog.captchaai.com/building-client-captcha-pipelines-captchaai)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/building-client-captcha-pipelines-captchaai
   ```
