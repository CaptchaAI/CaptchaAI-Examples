...
**[CAPTCHA Handling for University Course Registration Testing](https://blog.captchaai.com/university-registration-captcha-testing)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/university-registration-captcha-testing
   ```
