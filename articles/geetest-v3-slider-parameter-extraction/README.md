...
**[GeeTest v3 Slider Parameter Extraction and Solving](https://blog.captchaai.com/geetest-v3-slider-parameter-extraction)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/geetest-v3-slider-parameter-extraction
   ```
