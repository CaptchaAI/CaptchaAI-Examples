# Auto-Solve Toggles in the CaptchaAI Extension: Recommended Setup
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-auto-solve-toggles-recommended-setup
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-auto-solve-toggles-recommended-setup/` directory (not inside a language folder)
