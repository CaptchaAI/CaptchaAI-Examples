# Pairing the CaptchaAI Extension with Residential Proxies
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-with-residential-proxies-best-practices
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-with-residential-proxies-best-practices/` directory (not inside a language folder)
