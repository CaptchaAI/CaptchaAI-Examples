# Solving CAPTCHAs Inside Google Cloud Workflows
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-gcp-workflows
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-gcp-workflows/` directory (not inside a language folder)
