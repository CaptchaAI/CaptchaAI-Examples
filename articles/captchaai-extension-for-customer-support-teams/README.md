# Using the CaptchaAI Extension Inside a Customer Support Workflow
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-for-customer-support-teams
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-for-customer-support-teams/` directory (not inside a language folder)
