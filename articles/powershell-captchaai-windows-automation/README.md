...
**[PowerShell + CaptchaAI: Windows Automation CAPTCHA Solving](https://blog.captchaai.com/powershell-captchaai-windows-automation)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/powershell-captchaai-windows-automation
   ```
