...
**[Node.js Worker Threads for Parallel CAPTCHA Solving](https://blog.captchaai.com/nodejs-worker-threads-parallel-captcha-solving)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/nodejs-worker-threads-parallel-captcha-solving
   ```
