# CDN Pricing Monitoring With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/cdn-pricing-monitoring-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/cdn-pricing-monitoring-captcha-handling/` directory (not inside a language folder)
