# Building Event-Driven CAPTCHA Solving with AWS SNS and CaptchaAI
...
**[Building Event-Driven CAPTCHA Solving with AWS SNS and CaptchaAI](https://blog.captchaai.com/aws-sns-captchaai-event-driven-captcha)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/aws-sns-captchaai-event-driven-captcha
   ```
