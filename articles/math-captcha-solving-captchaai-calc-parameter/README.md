...
**[Math CAPTCHA Solving with CaptchaAI calc Parameter](https://blog.captchaai.com/math-captcha-solving-captchaai-calc-parameter)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/math-captcha-solving-captchaai-calc-parameter
   ```
