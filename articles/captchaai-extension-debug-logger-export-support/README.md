# Exporting Extension Debug Logs to Send to CaptchaAI Support
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-debug-logger-export-support
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-debug-logger-export-support/` directory (not inside a language folder)
