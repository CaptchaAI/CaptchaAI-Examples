...
**[Selenium Wire + CaptchaAI: Request Interception for CAPTCHA Solving](https://blog.captchaai.com/selenium-wire-captchaai-request-interception)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/selenium-wire-captchaai-request-interception
   ```
