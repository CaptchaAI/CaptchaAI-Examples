# How reCAPTCHA Enterprise Payment Fraud Detection Works

Full working example for solving reCAPTCHA Enterprise using the CaptchaAI API.
...
- A target page with reCAPTCHA Enterprise for testing
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-recaptcha-enterprise-payment-fraud-works
   ```
...
```
[*] Submitting reCAPTCHA Enterprise task...
...
- Make sure `.env` file is in the `articles/how-recaptcha-enterprise-payment-fraud-works/` directory (not inside a language folder)
