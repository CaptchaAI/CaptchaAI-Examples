# Building an SEO Rank Tracker With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/seo-rank-tracker-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/seo-rank-tracker-captcha-handling/` directory (not inside a language folder)
