...
**[Custom Timeout Settings for Different CAPTCHA Types](https://blog.captchaai.com/custom-timeout-settings-captcha-types)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/custom-timeout-settings-captcha-types
   ```
