...
**[GitHub Actions + CaptchaAI: CI/CD CAPTCHA Testing](https://blog.captchaai.com/github-actions-captchaai-cicd-captcha-testing)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/github-actions-captchaai-cicd-captcha-testing
   ```
