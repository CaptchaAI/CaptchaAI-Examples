# How reCAPTCHA Enterprise Account Defender Works
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-recaptcha-enterprise-account-defender-works
   ```
...
- Make sure `.env` file is in the `articles/how-recaptcha-enterprise-account-defender-works/` directory (not inside a language folder)
