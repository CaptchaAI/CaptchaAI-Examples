...
**[HTTP Replay for CAPTCHA API Debugging: Save and Reproduce Errors](https://blog.captchaai.com/http-replay-captcha-api-debugging)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/http-replay-captcha-api-debugging
   ```
