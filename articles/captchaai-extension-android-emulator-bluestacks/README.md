# Running the CaptchaAI Extension Inside Bluestacks / Android Emulator Chrome
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-android-emulator-bluestacks
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-android-emulator-bluestacks/` directory (not inside a language folder)
