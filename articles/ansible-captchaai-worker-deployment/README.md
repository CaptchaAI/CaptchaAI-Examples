...
**[Ansible Playbooks for CaptchaAI Worker Deployment](https://blog.captchaai.com/ansible-captchaai-worker-deployment)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/ansible-captchaai-worker-deployment
   ```
