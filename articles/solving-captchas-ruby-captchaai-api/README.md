...
**[Solving CAPTCHAs with Ruby and CaptchaAI API](https://blog.captchaai.com/solving-captchas-ruby-captchaai-api)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captchas-ruby-captchaai-api
   ```
