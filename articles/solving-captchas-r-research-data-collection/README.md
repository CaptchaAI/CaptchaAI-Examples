...
**[Solving CAPTCHAs with R for Research Data Collection](https://blog.captchaai.com/solving-captchas-r-research-data-collection)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captchas-r-research-data-collection
   ```
