...
**[Rate-Limited Concurrency: Token Bucket for CAPTCHA API Calls](https://blog.captchaai.com/token-bucket-rate-limited-captcha-concurrency)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/token-bucket-rate-limited-captcha-concurrency
   ```
