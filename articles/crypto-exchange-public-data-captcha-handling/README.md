# Crypto Exchange Public-Data Pulls With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/crypto-exchange-public-data-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/crypto-exchange-public-data-captcha-handling/` directory (not inside a language folder)
