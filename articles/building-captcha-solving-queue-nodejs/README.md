# Building a CAPTCHA Solving Queue in Node.js
...
**[Building a CAPTCHA Solving Queue in Node.js](https://blog.captchaai.com/building-captcha-solving-queue-nodejs)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/building-captcha-solving-queue-nodejs
   ```
