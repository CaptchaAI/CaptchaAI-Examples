# CaptchaAI CLI Tool vs Chrome Extension: When Each Wins
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-cli-tool-vs-chrome-extension
   ```
...
- Make sure `.env` file is in the `articles/captchaai-cli-tool-vs-chrome-extension/` directory (not inside a language folder)
