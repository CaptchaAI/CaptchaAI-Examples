# Solving CAPTCHAs From Webflow Logic Flows
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-webflow-logic-flows
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-webflow-logic-flows/` directory (not inside a language folder)
