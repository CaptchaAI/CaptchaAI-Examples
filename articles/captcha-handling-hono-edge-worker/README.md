# Solving CAPTCHAs Inside Hono Edge Workers
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-hono-edge-worker
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-hono-edge-worker/` directory (not inside a language folder)
