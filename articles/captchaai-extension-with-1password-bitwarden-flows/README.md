# Pairing the CaptchaAI Extension with 1Password and Bitwarden
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-with-1password-bitwarden-flows
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-with-1password-bitwarden-flows/` directory (not inside a language folder)
