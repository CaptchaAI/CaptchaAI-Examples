# Storing CaptchaAI API Keys in AWS Secrets Manager
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/security-aws-secrets-manager-captchaai
   ```
...
- Make sure `.env` file is in the `articles/security-aws-secrets-manager-captchaai/` directory (not inside a language folder)
