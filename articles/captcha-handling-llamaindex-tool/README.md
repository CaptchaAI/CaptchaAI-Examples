# Registering CaptchaAI as a LlamaIndex Tool
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-llamaindex-tool
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-llamaindex-tool/` directory (not inside a language folder)
