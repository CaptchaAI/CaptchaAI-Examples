...
**[CAPTCHA Solving in Ticket Purchase Automation](https://blog.captchaai.com/captcha-solving-ticket-purchase-automation)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-solving-ticket-purchase-automation
   ```
