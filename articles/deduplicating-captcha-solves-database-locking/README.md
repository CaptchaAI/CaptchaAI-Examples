# Deduplicating CAPTCHA Solve Requests with Database Locking
...
**[Deduplicating CAPTCHA Solve Requests with Database Locking](https://blog.captchaai.com/deduplicating-captcha-solves-database-locking)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/deduplicating-captcha-solves-database-locking
   ```
