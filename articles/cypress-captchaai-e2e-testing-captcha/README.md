# Cypress + CaptchaAI: E2E Testing with CAPTCHA Handling
...
**[Cypress + CaptchaAI: E2E Testing with CAPTCHA Handling](https://blog.captchaai.com/cypress-captchaai-e2e-testing-captcha)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/cypress-captchaai-e2e-testing-captcha
   ```
