...
**[Shipping and Logistics Rate Scraping with CAPTCHA Solving](https://blog.captchaai.com/shipping-logistics-rate-scraping-captcha)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/shipping-logistics-rate-scraping-captcha
   ```
