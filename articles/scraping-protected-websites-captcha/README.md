...
**[Scraping CAPTCHA-Protected Websites](https://blog.captchaai.com/scraping-protected-websites-captcha)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/scraping-protected-websites-captcha
   ```
