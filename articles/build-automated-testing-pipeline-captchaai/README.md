# Build an Automated Testing Pipeline with CaptchaAI
...
**[Build an Automated Testing Pipeline with CaptchaAI](https://blog.captchaai.com/build-automated-testing-pipeline-captchaai)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/build-automated-testing-pipeline-captchaai
   ```
