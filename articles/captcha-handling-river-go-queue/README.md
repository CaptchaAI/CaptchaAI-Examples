# Solving CAPTCHAs With the River Go Queue
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-river-go-queue
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-river-go-queue/` directory (not inside a language folder)
