...
**[n8n + CaptchaAI: No-Code CAPTCHA Solving Workflow](https://blog.captchaai.com/n8n-captchaai-no-code-automation)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/n8n-captchaai-no-code-automation
   ```
