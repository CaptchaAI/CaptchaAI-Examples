# Running the CaptchaAI Extension Across Multiple Chrome Profiles
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-multiple-chrome-profiles
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-multiple-chrome-profiles/` directory (not inside a language folder)
