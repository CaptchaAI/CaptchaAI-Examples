# How Shape Security / Imperva Challenge Works
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-shape-security-imperva-challenge-works
   ```
...
- Make sure `.env` file is in the `articles/how-shape-security-imperva-challenge-works/` directory (not inside a language folder)
