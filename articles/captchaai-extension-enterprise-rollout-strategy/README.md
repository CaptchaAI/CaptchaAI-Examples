# Rolling Out the CaptchaAI Extension Across an Enterprise via Group Policy
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-enterprise-rollout-strategy
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-enterprise-rollout-strategy/` directory (not inside a language folder)
