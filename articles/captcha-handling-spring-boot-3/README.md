# Solving CAPTCHAs in a Spring Boot 3 Service
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-spring-boot-3
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-spring-boot-3/` directory (not inside a language folder)
