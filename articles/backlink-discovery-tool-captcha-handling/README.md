# Building a Backlink Discovery Tool With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/backlink-discovery-tool-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/backlink-discovery-tool-captcha-handling/` directory (not inside a language folder)
