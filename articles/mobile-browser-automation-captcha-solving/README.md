...
**[Mobile Browser Automation CAPTCHA Solving with CaptchaAI](https://blog.captchaai.com/mobile-browser-automation-captcha-solving)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/mobile-browser-automation-captcha-solving
   ```
