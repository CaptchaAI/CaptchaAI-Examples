# Review Aggregator (Google + Trustpilot) With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/review-aggregator-google-trustpilot-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/review-aggregator-google-trustpilot-captcha-handling/` directory (not inside a language folder)
