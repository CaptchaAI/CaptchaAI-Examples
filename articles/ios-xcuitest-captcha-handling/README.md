...
**[iOS Automation CAPTCHA Handling with XCUITest and CaptchaAI](https://blog.captchaai.com/ios-xcuitest-captcha-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/ios-xcuitest-captcha-handling
   ```
