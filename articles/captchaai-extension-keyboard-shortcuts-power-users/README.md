# Keyboard Shortcuts and Power-User Tips for the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-keyboard-shortcuts-power-users
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-keyboard-shortcuts-power-users/` directory (not inside a language folder)
