# CaptchaAI Extension: API Key Validate-and-Save Troubleshooting
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-api-key-validation-troubleshooting
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-api-key-validation-troubleshooting/` directory (not inside a language folder)
