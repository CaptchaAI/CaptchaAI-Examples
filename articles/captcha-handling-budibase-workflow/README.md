# Solving CAPTCHAs From a Budibase Workflow
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-budibase-workflow
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-budibase-workflow/` directory (not inside a language folder)
