...
**[Python asyncio + CaptchaAI: Concurrent Solving at Scale](https://blog.captchaai.com/python-asyncio-captchaai-concurrent-solving)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/python-asyncio-captchaai-concurrent-solving
   ```
