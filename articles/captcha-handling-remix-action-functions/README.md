# Solving CAPTCHAs in Remix Action Functions
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-remix-action-functions
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-remix-action-functions/` directory (not inside a language folder)
