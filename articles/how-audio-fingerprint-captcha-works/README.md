# How Audio-Fingerprint CAPTCHAs Work
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-audio-fingerprint-captcha-works
   ```
...
- Make sure `.env` file is in the `articles/how-audio-fingerprint-captcha-works/` directory (not inside a language folder)
