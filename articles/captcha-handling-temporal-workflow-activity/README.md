# Wrapping CaptchaAI as a Temporal Workflow Activity
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-temporal-workflow-activity
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-temporal-workflow-activity/` directory (not inside a language folder)
