# Solving CAPTCHAs in SvelteKit Form Actions
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-svelte-kit-form-actions
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-svelte-kit-form-actions/` directory (not inside a language folder)
