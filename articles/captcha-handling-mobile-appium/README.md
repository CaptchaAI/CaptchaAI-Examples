...
**[CAPTCHA Handling in Mobile Apps with Appium](https://blog.captchaai.com/captcha-handling-mobile-appium)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-mobile-appium
   ```
