# Solving CAPTCHAs from Mojo (Future-Compatible Pattern)
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-mojo-language-future
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-mojo-language-future/` directory (not inside a language folder)
