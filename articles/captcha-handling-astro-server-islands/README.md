# CAPTCHA Solving Inside Astro Server Islands
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-astro-server-islands
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-astro-server-islands/` directory (not inside a language folder)
