...
**[CaptchaAI Balance Check and Auto-Refill Integration](https://blog.captchaai.com/captchaai-balance-check-auto-refill)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-balance-check-auto-refill
   ```
