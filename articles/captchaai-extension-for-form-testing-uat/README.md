# Form Testing and UAT with the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-for-form-testing-uat
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-for-form-testing-uat/` directory (not inside a language folder)
