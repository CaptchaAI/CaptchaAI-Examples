# Solving CAPTCHAs From a ToolJet Workflow
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-tooljet-workflow
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-tooljet-workflow/` directory (not inside a language folder)
