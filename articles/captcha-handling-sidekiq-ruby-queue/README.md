# Solving CAPTCHAs With Sidekiq in Ruby
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-sidekiq-ruby-queue
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-sidekiq-ruby-queue/` directory (not inside a language folder)
