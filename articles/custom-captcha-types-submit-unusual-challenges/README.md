...
**[Custom CAPTCHA Types: Submitting Unusual Challenges to CaptchaAI](https://blog.captchaai.com/custom-captcha-types-submit-unusual-challenges)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/custom-captcha-types-submit-unusual-challenges
   ```
