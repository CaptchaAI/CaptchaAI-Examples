...
fun main() {
    ...
    val body = getEnv(env, "CAPTCHA_BODY")
    ...
    val submitParams = "key=${URLEncoder.encode(apiKey, enc)}&method=base64&body=${URLEncoder.encode(body, enc)}&json=1"
    ...
    var elapsed = 10; var attempt = 0; var backoff = pollInterval
