# Building a Model Context Protocol (MCP) Server for CAPTCHA Solving
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-mcp-server-pattern
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-mcp-server-pattern/` directory (not inside a language folder)
