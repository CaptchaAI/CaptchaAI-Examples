# Solving CAPTCHAs Inside an Actix Rust Server
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-actix-rust-server
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-actix-rust-server/` directory (not inside a language folder)
