...
**[Queue-Based Batch CAPTCHA Processing with Priority Levels](https://blog.captchaai.com/queue-batch-captcha-priority-processing)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/queue-batch-captcha-priority-processing
   ```
