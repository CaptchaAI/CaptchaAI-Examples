# Solving CAPTCHAs From a Supabase Edge Function
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-supabase-edge-functions
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-supabase-edge-functions/` directory (not inside a language folder)
