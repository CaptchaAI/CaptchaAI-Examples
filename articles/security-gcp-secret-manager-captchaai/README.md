# Storing CaptchaAI API Keys in GCP Secret Manager
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/security-gcp-secret-manager-captchaai
   ```
...
- Make sure `.env` file is in the `articles/security-gcp-secret-manager-captchaai/` directory (not inside a language folder)
