...
**[Apify + CaptchaAI: Cloud Scraping Platform Integration](https://blog.captchaai.com/apify-captchaai-cloud-scraping-integration)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/apify-captchaai-cloud-scraping-integration
   ```
