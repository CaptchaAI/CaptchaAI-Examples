...
**[Scrapy Spider Middleware for CaptchaAI: Advanced Patterns](https://blog.captchaai.com/scrapy-spider-middleware-captchaai-advanced)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/scrapy-spider-middleware-captchaai-advanced
   ```
