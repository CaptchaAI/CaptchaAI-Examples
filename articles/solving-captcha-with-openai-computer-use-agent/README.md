# Solving CAPTCHAs Inside an OpenAI Computer-Use Agent
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captcha-with-openai-computer-use-agent
   ```
...
- Make sure `.env` file is in the `articles/solving-captcha-with-openai-computer-use-agent/` directory (not inside a language folder)
