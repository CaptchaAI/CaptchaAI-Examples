...
**[Build a Price Comparison Bot with Python and CaptchaAI](https://blog.captchaai.com/build-price-comparison-bot-python-captchaai)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/build-price-comparison-bot-python-captchaai
   ```
