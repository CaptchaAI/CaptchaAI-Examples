...
**[Chrome DevTools Network Tab for CAPTCHA Debugging](https://blog.captchaai.com/chrome-devtools-network-captcha-debugging)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/chrome-devtools-network-captcha-debugging
   ```
