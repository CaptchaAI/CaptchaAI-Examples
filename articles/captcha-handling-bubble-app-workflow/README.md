# Solving CAPTCHAs From a Bubble.io API Workflow
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-bubble-app-workflow
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-bubble-app-workflow/` directory (not inside a language folder)
