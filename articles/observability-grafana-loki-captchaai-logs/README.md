# Centralizing CaptchaAI Logs in Grafana Loki
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/observability-grafana-loki-captchaai-logs
   ```
...
- Make sure `.env` file is in the `articles/observability-grafana-loki-captchaai-logs/` directory (not inside a language folder)
