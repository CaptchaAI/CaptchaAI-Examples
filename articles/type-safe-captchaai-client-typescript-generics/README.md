...
**[Type-Safe CaptchaAI Client with TypeScript Generics](https://blog.captchaai.com/type-safe-captchaai-client-typescript-generics)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/type-safe-captchaai-client-typescript-generics
   ```
