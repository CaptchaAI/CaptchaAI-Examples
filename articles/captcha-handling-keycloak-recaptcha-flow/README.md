# Pairing CaptchaAI With a Keycloak reCAPTCHA Flow
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-keycloak-recaptcha-flow
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-keycloak-recaptcha-flow/` directory (not inside a language folder)
