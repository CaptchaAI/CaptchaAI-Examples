...
**[CAPTCHA Session State Management Across Distributed Workers](https://blog.captchaai.com/captcha-session-state-distributed-workers)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-session-state-distributed-workers
   ```
