# Solving CAPTCHAs With Render Background Workers
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-render-background-workers
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-render-background-workers/` directory (not inside a language folder)
