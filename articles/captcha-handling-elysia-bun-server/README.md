# Solving CAPTCHAs Inside an Elysia + Bun Server
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-elysia-bun-server
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-elysia-bun-server/` directory (not inside a language folder)
