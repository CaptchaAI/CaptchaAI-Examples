...
**[How to Solve Image CAPTCHA with Base64 API](https://blog.captchaai.com/solve-image-captcha-base64-api)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solve-image-captcha-base64-api
   ```
