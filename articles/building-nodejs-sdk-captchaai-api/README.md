...
**[Building a Node.js SDK for CaptchaAI API](https://blog.captchaai.com/building-nodejs-sdk-captchaai-api)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/building-nodejs-sdk-captchaai-api
   ```
