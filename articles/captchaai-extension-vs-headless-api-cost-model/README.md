# CaptchaAI Extension vs Headless API Cost Model: Same Price, Different Volume
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-vs-headless-api-cost-model
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-vs-headless-api-cost-model/` directory (not inside a language folder)
