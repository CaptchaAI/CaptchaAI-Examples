# Storing CaptchaAI Secrets With age-Encrypted Files
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/security-age-encrypted-secrets-captchaai
   ```
...
- Make sure `.env` file is in the `articles/security-age-encrypted-secrets-captchaai/` directory (not inside a language folder)
