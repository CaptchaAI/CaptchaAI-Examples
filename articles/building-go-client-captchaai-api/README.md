...
**[Building a Go Client Library for CaptchaAI API](https://blog.captchaai.com/building-go-client-captchaai-api)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/building-go-client-captchaai-api
   ```
