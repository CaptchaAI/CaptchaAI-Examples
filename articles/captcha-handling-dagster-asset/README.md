# Calling CaptchaAI From a Dagster Asset
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-dagster-asset
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-dagster-asset/` directory (not inside a language folder)
