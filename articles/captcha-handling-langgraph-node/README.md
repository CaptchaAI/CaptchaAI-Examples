# Adding a CaptchaAI Node to a LangGraph Workflow
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-langgraph-node
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-langgraph-node/` directory (not inside a language folder)
