...
**[Async CAPTCHA Solving in C# with Task.WhenAll and CaptchaAI](https://blog.captchaai.com/csharp-task-whenall-captchaai-async)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/csharp-task-whenall-captchaai-async
   ```
