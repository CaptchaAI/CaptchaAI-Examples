...
**[Google Cloud Functions + CaptchaAI Integration](https://blog.captchaai.com/google-cloud-functions-captchaai-integration)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/google-cloud-functions-captchaai-integration
   ```
