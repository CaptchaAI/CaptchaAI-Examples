# Airtable + CaptchaAI: Database-Triggered CAPTCHA Solving
...
**[Airtable + CaptchaAI: Database-Triggered CAPTCHA Solving](https://blog.captchaai.com/airtable-captchaai-database-captcha)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/airtable-captchaai-database-captcha
   ```
