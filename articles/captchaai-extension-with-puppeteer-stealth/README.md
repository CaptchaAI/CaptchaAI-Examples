# Pairing the CaptchaAI Extension with Puppeteer-Stealth
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-with-puppeteer-stealth
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-with-puppeteer-stealth/` directory (not inside a language folder)
