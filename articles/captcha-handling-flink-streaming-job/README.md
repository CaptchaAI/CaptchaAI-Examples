# Solving CAPTCHAs Inside an Apache Flink Streaming Job
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-flink-streaming-job
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-flink-streaming-job/` directory (not inside a language folder)
