...
**[Google Apps Script + CaptchaAI: Spreadsheet CAPTCHA Automation](https://blog.captchaai.com/google-apps-script-captchaai-captcha)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/google-apps-script-captchaai-captcha
   ```
