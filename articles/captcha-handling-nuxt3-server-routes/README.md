# Solving CAPTCHAs in Nuxt 3 Server Routes
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-nuxt3-server-routes
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-nuxt3-server-routes/` directory (not inside a language folder)
