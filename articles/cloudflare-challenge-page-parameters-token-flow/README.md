...
**[Cloudflare Challenge Page Parameters and Token Flow](https://blog.captchaai.com/cloudflare-challenge-page-parameters-token-flow)**

## Prerequisites

- A CaptchaAI account with API key ([get one here](https://captchaai.com))
- A target page with Cloudflare Challenge for testing
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/cloudflare-challenge-page-parameters-token-flow
   ```
...
1. **Submit** â€” Sends the CAPTCHA parameters to `https://ocr.captchaai.com/in.php` using method `cloudflare_challenge`
