...
**[Solving CAPTCHAs with Scala and CaptchaAI API](https://blog.captchaai.com/solving-captchas-scala-captchaai-api)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captchas-scala-captchaai-api
   ```
