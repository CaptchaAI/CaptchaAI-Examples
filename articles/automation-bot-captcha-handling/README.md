...
**[Automation Bot CAPTCHA Handling with CaptchaAI](https://blog.captchaai.com/automation-bot-captcha-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/automation-bot-captcha-handling
   ```
