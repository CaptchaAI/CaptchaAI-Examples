# GDS India / VFS Portal CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/gds-india-vfs-portal-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/gds-india-vfs-portal-captcha-handling/` directory (not inside a language folder)
