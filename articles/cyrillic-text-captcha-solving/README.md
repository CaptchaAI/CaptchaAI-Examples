...
**[Cyrillic Text CAPTCHA Solving with CaptchaAI](https://blog.captchaai.com/cyrillic-text-captcha-solving)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/cyrillic-text-captcha-solving
   ```
