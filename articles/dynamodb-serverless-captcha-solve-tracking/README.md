# DynamoDB for Serverless CAPTCHA Solve Tracking
...
**[DynamoDB for Serverless CAPTCHA Solve Tracking](https://blog.captchaai.com/dynamodb-serverless-captcha-solve-tracking)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/dynamodb-serverless-captcha-solve-tracking
   ```
