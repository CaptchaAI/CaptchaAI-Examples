# No Firefox Build? Alternative CaptchaAI Workflows for Firefox Users
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-firefox-alternative-workflow
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-firefox-alternative-workflow/` directory (not inside a language folder)
