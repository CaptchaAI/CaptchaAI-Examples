# Server-Sent Events for Real-Time CAPTCHA Solve Notifications
...
**[Server-Sent Events for Real-Time CAPTCHA Solve Notifications](https://blog.captchaai.com/sse-realtime-captcha-solve-notifications)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/sse-realtime-captcha-solve-notifications
   ```
