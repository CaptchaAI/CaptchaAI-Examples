# Plan Threads in the CaptchaAI Extension Explained
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-plan-threads-explained
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-plan-threads-explained/` directory (not inside a language folder)
