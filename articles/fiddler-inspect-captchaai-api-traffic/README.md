...
**[Using Fiddler to Inspect CaptchaAI API Traffic](https://blog.captchaai.com/fiddler-inspect-captchaai-api-traffic)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/fiddler-inspect-captchaai-api-traffic
   ```
