# Migrating From the DeathByCaptcha Extension to the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/migration-from-deathbycaptcha-extension-to-captchaai
   ```
...
- Make sure `.env` file is in the `articles/migration-from-deathbycaptcha-extension-to-captchaai/` directory (not inside a language folder)
