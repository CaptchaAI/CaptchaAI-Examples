...
**[Auto-Scaling CAPTCHA Solving Workers](https://blog.captchaai.com/auto-scaling-captcha-solving-workers)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/auto-scaling-captcha-solving-workers
   ```
