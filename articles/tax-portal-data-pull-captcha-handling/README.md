# Authorized Tax Portal Data-Pull CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/tax-portal-data-pull-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/tax-portal-data-pull-captcha-handling/` directory (not inside a language folder)
