# Adding CaptchaAI as a Tool in the Vercel AI SDK
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-vercel-ai-sdk-tools
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-vercel-ai-sdk-tools/` directory (not inside a language folder)
