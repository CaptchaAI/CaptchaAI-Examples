# Solving CAPTCHAs With Cloudflare Durable Objects State
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-cloudflare-durable-objects
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-cloudflare-durable-objects/` directory (not inside a language folder)
