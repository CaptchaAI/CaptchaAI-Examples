...
**[Testing CaptchaAI Before Full Migration: Parallel Run Guide](https://blog.captchaai.com/testing-captchaai-parallel-run-migration)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/testing-captchaai-parallel-run-migration
   ```
