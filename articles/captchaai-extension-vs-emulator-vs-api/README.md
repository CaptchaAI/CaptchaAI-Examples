# CaptchaAI Extension vs Emulator vs API: Which One Fits Your Workflow
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-vs-emulator-vs-api
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-vs-emulator-vs-api/` directory (not inside a language folder)
