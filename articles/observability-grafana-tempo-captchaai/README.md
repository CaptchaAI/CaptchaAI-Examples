# Tracing CaptchaAI Calls in Grafana Tempo
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/observability-grafana-tempo-captchaai
   ```
...
- Make sure `.env` file is in the `articles/observability-grafana-tempo-captchaai/` directory (not inside a language folder)
