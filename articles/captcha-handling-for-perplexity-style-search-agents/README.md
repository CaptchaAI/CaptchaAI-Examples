# CAPTCHA Handling for Perplexity-Style Search Agents
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-for-perplexity-style-search-agents
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-for-perplexity-style-search-agents/` directory (not inside a language folder)
