# CAPTCHA Handling for LLM Training-Data Scraping
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-for-llm-training-data-scraping
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-for-llm-training-data-scraping/` directory (not inside a language folder)
