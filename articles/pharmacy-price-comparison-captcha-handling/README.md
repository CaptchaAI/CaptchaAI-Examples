# CAPTCHA Handling for Pharmacy Price Comparison
...
**[CAPTCHA Handling for Pharmacy Price Comparison](https://blog.captchaai.com/pharmacy-price-comparison-captcha-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/pharmacy-price-comparison-captcha-handling
   ```
