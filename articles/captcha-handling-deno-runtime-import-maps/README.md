# A Deno + CaptchaAI Setup with Import Maps
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-deno-runtime-import-maps
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-deno-runtime-import-maps/` directory (not inside a language folder)
