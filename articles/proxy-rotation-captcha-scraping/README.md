...
**[Proxy Rotation for CAPTCHA Scraping](https://blog.captchaai.com/proxy-rotation-captcha-scraping)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/proxy-rotation-captcha-scraping
   ```
