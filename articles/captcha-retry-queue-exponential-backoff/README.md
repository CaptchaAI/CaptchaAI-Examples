...
**[CAPTCHA Retry Queue with Exponential Backoff](https://blog.captchaai.com/captcha-retry-queue-exponential-backoff)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-retry-queue-exponential-backoff
   ```
