# Using the CaptchaAI Extension From a Browser Behind an SSH Jumphost
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-ssh-jumphost-bastion-flows
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-ssh-jumphost-bastion-flows/` directory (not inside a language folder)
