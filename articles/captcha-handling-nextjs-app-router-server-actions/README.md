# Solving CAPTCHAs in Next.js App Router Server Actions
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-nextjs-app-router-server-actions
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-nextjs-app-router-server-actions/` directory (not inside a language folder)
