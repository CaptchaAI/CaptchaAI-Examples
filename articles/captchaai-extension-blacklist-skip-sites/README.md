# Skipping Sites with the CaptchaAI Extension Blacklist
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-blacklist-skip-sites
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-blacklist-skip-sites/` directory (not inside a language folder)
