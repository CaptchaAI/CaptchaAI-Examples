...
**[SOCKS5 Proxy + CaptchaAI: Setup and Configuration Guide](https://blog.captchaai.com/socks5-proxy-captchaai-setup-configuration)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/socks5-proxy-captchaai-setup-configuration
   ```
