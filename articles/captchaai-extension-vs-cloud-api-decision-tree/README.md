# Should You Use the CaptchaAI Extension or the Cloud API? Decision Tree
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-vs-cloud-api-decision-tree
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-vs-cloud-api-decision-tree/` directory (not inside a language folder)
