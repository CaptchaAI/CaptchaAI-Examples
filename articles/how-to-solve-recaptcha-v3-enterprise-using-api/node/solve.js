...
const CAPTCHA_ACTION = process.env.CAPTCHA_ACTION || "verify";
const CAPTCHA_MIN_SCORE = process.env.CAPTCHA_MIN_SCORE || "0.3";
const CAPTCHA_DATA_S = process.env.CAPTCHA_DATA_S || "";
...
function validateConfig() {
  ...
  if (!CAPTCHA_SITEKEY || CAPTCHA_SITEKEY === "YOUR_SITE_KEY") {
    ...
    console.log("    Add the reCAPTCHA v3 Enterprise sitekey from your target page to .env");
    process.exit(1);
  }
...
async function submitTask() {
  console.log("[*] Submitting reCAPTCHA v3 Enterprise task...");
