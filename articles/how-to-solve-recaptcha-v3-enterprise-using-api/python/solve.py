...
CAPTCHA_ACTION = os.getenv("CAPTCHA_ACTION", "verify")
CAPTCHA_MIN_SCORE = os.getenv("CAPTCHA_MIN_SCORE", "0.3")
CAPTCHA_DATA_S = os.getenv("CAPTCHA_DATA_S", "")
...
def validate_config() -> None:
    ...
    if not CAPTCHA_SITEKEY or CAPTCHA_SITEKEY == "YOUR_SITE_KEY":
        ...
        print("    Add the reCAPTCHA v3 Enterprise sitekey from your target page to .env")
        sys.exit(1)
...
def submit_task() -> str:
    ...
    print("[*] Submitting reCAPTCHA v3 Enterprise task...")
    payload = {
        "key": API_KEY,
