...
**[Make (Integromat) + CaptchaAI: Visual CAPTCHA Automation](https://blog.captchaai.com/make-integromat-captchaai-captcha-automation)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/make-integromat-captchaai-captcha-automation
   ```
