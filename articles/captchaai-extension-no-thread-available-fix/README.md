# Extension Error: No Threads Available — How to Fix It
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-no-thread-available-fix
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-no-thread-available-fix/` directory (not inside a language folder)
