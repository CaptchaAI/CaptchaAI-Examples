# How Proof-of-Work CAPTCHAs Work and How to Handle Them
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-pow-captcha-works-and-how-to-handle-it
   ```
...
- Make sure `.env` file is in the `articles/how-pow-captcha-works-and-how-to-handle-it/` directory (not inside a language folder)
