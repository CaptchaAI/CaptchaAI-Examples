...
**[Selenium Grid + CaptchaAI: Distributed CAPTCHA Solving](https://blog.captchaai.com/selenium-grid-captchaai-distributed-solving)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/selenium-grid-captchaai-distributed-solving
   ```
