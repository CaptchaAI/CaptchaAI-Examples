...
**[CaptchaAI Monitoring with New Relic: APM Integration](https://blog.captchaai.com/captchaai-monitoring-new-relic-apm)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-monitoring-new-relic-apm
   ```
