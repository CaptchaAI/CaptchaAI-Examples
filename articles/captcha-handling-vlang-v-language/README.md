...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-vlang-v-language
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-vlang-v-language/` directory (not inside a language folder)
