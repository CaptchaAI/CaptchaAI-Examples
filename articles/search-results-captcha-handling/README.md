...
**[Search Results Data Collection with CAPTCHA Handling](https://blog.captchaai.com/search-results-captcha-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/search-results-captcha-handling
   ```
