...
def validate_config() -> None:
    ...
    if not API_KEY or API_KEY == "YOUR_API_KEY":
        ...
        sys.exit(1)
    if not CAPTCHA_GT or CAPTCHA_GT == "YOUR_CAPTCHA_ID":
        print("[!] ERROR: CAPTCHA_GT is not set.")
        print("    Find the captcha_id in the page source or GeeTest v4 initialization call.")
        sys.exit(1)
...
def submit_task() -> str:
    ...
    print("[*] Submitting GeeTest v4 task...")
    payload = {
        "key": API_KEY,
        "method": "geetest",
        "gt": CAPTCHA_GT,
    ...
    if data.get("status") != 1:
        ...
        if error in AUTH_ERRORS:
            ...
            print("    Verify your gt (captcha_id) and page URL are correct.")
...
def main() -> None:
    ...
    print()
    print("Next step: submit these five values to the site's")
    print("GeeTest v4 verification endpoint.")
