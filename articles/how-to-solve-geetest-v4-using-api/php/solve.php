...
if (empty($gt) || $gt === 'YOUR_CAPTCHA_ID') {
...
while ($elapsed < $maxTimeout) {
    ...
    if (($resultData['status'] ?? 0) === 1) {
        ...
        echo "[+] Solved!\n";
        echo "[+] captcha_id: " . $solution['captcha_id'] . "\n";
        echo "[+] lot_number: " . $solution['lot_number'] . "\n";
        echo "[+] pass_token: " . $solution['pass_token'] . "\n";
        echo "[+] gen_time: " . $solution['gen_time'] . "\n";
        echo "[+] captcha_output: " . $solution['captcha_output'] . "\n";
        echo "\n";
