# Cloudflare Turnstile Sitekey Extraction and Solving
...
**[Cloudflare Turnstile Sitekey Extraction and Solving](https://blog.captchaai.com/cloudflare-turnstile-sitekey-extraction)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/cloudflare-turnstile-sitekey-extraction
   ```
...
1. **Submit** â€” Sends the CAPTCHA parameters to `https://ocr.captchaai.com/in.php` using method `turnstile`
