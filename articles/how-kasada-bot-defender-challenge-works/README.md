# How Kasada Bot Defender Challenge Works
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-kasada-bot-defender-challenge-works
   ```
...
- Make sure `.env` file is in the `articles/how-kasada-bot-defender-challenge-works/` directory (not inside a language folder)
