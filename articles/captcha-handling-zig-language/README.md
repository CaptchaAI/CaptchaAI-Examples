# Solving CAPTCHAs from a Zig HTTP Client
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-zig-language
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-zig-language/` directory (not inside a language folder)
