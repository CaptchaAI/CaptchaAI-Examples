# How ProCaptcha (Prosopo) Works Explained
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-procaptcha-prosopo-works-explained
   ```
...
- Make sure `.env` file is in the `articles/how-procaptcha-prosopo-works-explained/` directory (not inside a language folder)
