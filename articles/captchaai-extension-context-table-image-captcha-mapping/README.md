# Mapping Site-Specific Image CAPTCHAs with the Context Table
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-context-table-image-captcha-mapping
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-context-table-image-captcha-mapping/` directory (not inside a language folder)
