...
function validateConfig() {
  ...
  if (!CAPTCHA_INSTRUCTIONS) {
    ...
    console.log("    Provide text instructions (e.g. 'Select all images with a car').");
    process.exit(1);
  }
}
...
async function submitTask(imageB64) {
  console.log("[*] Submitting BLS CAPTCHA task...");

  const params = new URLSearchParams();
  params.append("key", API_KEY);
  params.append("method", "bls");
...
async function main() {
  ...
  console.log();
  console.log("Next step: use these selected indices to click the");
  console.log("corresponding images on the target page and submit.");
}
