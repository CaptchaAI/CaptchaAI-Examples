...
def validate_config() -> None:
    ...
    if not CAPTCHA_INSTRUCTIONS:
        ...
        print("    Provide text instructions (e.g. 'Select all images with a car').")
        sys.exit(1)
...
def submit_task(image_b64: str) -> str:
    ...
    print("[*] Submitting BLS CAPTCHA task...")
    payload = {
        "key": API_KEY,
        "method": "bls",
        "body": image_b64,
...
def main() -> None:
    ...
    print()
    print("Next step: use these selected indices to click the")
    print("corresponding images on the target page and submit.")
