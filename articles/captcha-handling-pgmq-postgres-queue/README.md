# Solving CAPTCHAs With pgmq on Postgres
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-pgmq-postgres-queue
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-pgmq-postgres-queue/` directory (not inside a language folder)
