...
**[Connection Pool Sizing for CAPTCHA API HTTP Clients](https://blog.captchaai.com/connection-pool-sizing-captcha-api-clients)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/connection-pool-sizing-captcha-api-clients
   ```
