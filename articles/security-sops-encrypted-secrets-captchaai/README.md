# Storing CaptchaAI Secrets With SOPS-Encrypted YAML
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/security-sops-encrypted-secrets-captchaai
   ```
...
- Make sure `.env` file is in the `articles/security-sops-encrypted-secrets-captchaai/` directory (not inside a language folder)
