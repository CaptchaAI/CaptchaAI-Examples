# GeeTest v3 Settings in the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-geetest-v3-settings-guide
   ```
...
| `CAPTCHA_GT` | gt from the target page | Yes |
| `CAPTCHA_CHALLENGE` | challenge from the target page | Yes |
...
- Make sure `.env` file is in the `articles/captchaai-extension-geetest-v3-settings-guide/` directory (not inside a language folder)
