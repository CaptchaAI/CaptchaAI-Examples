...
**[Phrase, MinLen, and MaxLen Parameters for Image CAPTCHA](https://blog.captchaai.com/phrase-min-max-length-parameters-image-captcha)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/phrase-min-max-length-parameters-image-captcha
   ```
