# Idempotent CAPTCHA Solving: Preventing Duplicate Solves
...
**[Idempotent CAPTCHA Solving: Preventing Duplicate Solves](https://blog.captchaai.com/idempotent-captcha-solving-prevent-duplicates)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/idempotent-captcha-solving-prevent-duplicates
   ```
