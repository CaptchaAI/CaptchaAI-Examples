...
**[Apache Kafka + CaptchaAI: Streaming CAPTCHA Task Processing](https://blog.captchaai.com/kafka-captchaai-streaming-captcha-processing)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/kafka-captchaai-streaming-captcha-processing
   ```
