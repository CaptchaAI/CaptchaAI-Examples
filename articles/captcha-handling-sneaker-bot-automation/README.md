...
**[CAPTCHA Handling for Sneaker Bot Automation](https://blog.captchaai.com/captcha-handling-sneaker-bot-automation)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-sneaker-bot-automation
   ```
