...
**[CaptchaAI IP Whitelisting and API Key Security](https://blog.captchaai.com/captchaai-ip-whitelisting-api-key-security)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-ip-whitelisting-api-key-security
   ```
