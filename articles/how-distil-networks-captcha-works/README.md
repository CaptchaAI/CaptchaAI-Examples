# How Distil Networks CAPTCHA Works
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-distil-networks-captcha-works
   ```
...
- Make sure `.env` file is in the `articles/how-distil-networks-captcha-works/` directory (not inside a language folder)
