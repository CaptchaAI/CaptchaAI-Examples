...
**[Solve reCAPTCHA Invisible with Node.js and CaptchaAI](https://blog.captchaai.com/solve-recaptcha-invisible-nodejs)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solve-recaptcha-invisible-nodejs
   ```
