...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-tencent-captcha-works
   ```
...
- Make sure `.env` file is in the `articles/how-tencent-captcha-works/` directory (not inside a language folder)
