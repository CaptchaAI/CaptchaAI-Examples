# Using captchaai.com/emulator to Debug the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-emulator-debugging-pages
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-emulator-debugging-pages/` directory (not inside a language folder)
