# Calling CaptchaAI From a FlutterFlow Cloud Function
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-flutterflow-cloud-function
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-flutterflow-cloud-function/` directory (not inside a language folder)
