# Managing CaptchaAI Credentials With Doppler
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/security-doppler-captchaai
   ```
...
- Make sure `.env` file is in the `articles/security-doppler-captchaai/` directory (not inside a language folder)
