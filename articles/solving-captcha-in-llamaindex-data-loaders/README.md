# Solving CAPTCHAs Inside LlamaIndex Data Loaders
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captcha-in-llamaindex-data-loaders
   ```
...
- Make sure `.env` file is in the `articles/solving-captcha-in-llamaindex-data-loaders/` directory (not inside a language folder)
