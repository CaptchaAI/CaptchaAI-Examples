# Using a CaptchaAI MCP Server Inside Cursor and Windsurf
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-mcp-server-cursor-windsurf
   ```
...
- Make sure `.env` file is in the `articles/captchaai-mcp-server-cursor-windsurf/` directory (not inside a language folder)
