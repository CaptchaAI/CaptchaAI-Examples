# Solving CAPTCHAs From a Retool Workflow (2026 Patterns)
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-retool-workflow-2026
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-retool-workflow-2026/` directory (not inside a language folder)
