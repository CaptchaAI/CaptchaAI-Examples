# CaptchaAI Extension vs CapSolver Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-vs-capsolver-extension
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-vs-capsolver-extension/` directory (not inside a language folder)
