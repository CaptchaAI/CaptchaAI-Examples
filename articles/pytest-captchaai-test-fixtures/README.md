...
**[Pytest Fixtures for CaptchaAI API Testing](https://blog.captchaai.com/pytest-captchaai-test-fixtures)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/pytest-captchaai-test-fixtures
   ```
