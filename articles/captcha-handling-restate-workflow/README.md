# Wrapping CaptchaAI as a Restate Workflow Step
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-restate-workflow
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-restate-workflow/` directory (not inside a language folder)
