# Centralizing CaptchaAI Logs in Axiom
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/observability-axiom-logs-captchaai
   ```
...
- Make sure `.env` file is in the `articles/observability-axiom-logs-captchaai/` directory (not inside a language folder)
