# Solving CAPTCHAs at Scale with Ray Distributed Tasks
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-ray-task-distributed
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-ray-task-distributed/` directory (not inside a language folder)
