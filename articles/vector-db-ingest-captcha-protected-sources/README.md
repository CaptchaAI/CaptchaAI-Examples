# Ingesting CAPTCHA-Protected Sources Into a Vector DB
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/vector-db-ingest-captcha-protected-sources
   ```
...
- Make sure `.env` file is in the `articles/vector-db-ingest-captcha-protected-sources/` directory (not inside a language folder)
