...
public class Solve {
    ...
    static final Set<String> INPUT_ERRORS = Set.of(
    ...
    public static void main(String[] args) throws Exception {
        ...
        String imageFile = getEnv("CAPTCHA_IMAGE_FILE", "captcha.png");
        ...
        System.out.println("[*] Submitting Image CAPTCHA task...");
        String postData = String.format(
            "key=%s&method=base64&body=%s&json=1",
            enc(apiKey), enc(imageB64)
        );
        ...
        // Poll for result
        System.out.println("[*] Waiting 10s before first poll...");
        Thread.sleep(10000);
        ...
        while (elapsed < maxTimeout) {
            ...
            if (status == 1) {
                String text = jsonStr(resultResp, "request");
                System.out.println("[+] Solved! Text: " + text);
                System.out.println();
                System.out.println("Next step: enter this text into the CAPTCHA input field");
                System.out.println("on the target page and submit the form.");
                return;
            }
            ...
            if (SOLVE_ERRORS.contains(request)) {
                ...
                System.out.println("    The CAPTCHA could not be solved. Verify the image and retry.");
                System.exit(1);
            }
    ...
    static void handleError(String error) {
        if (AUTH_ERRORS.contains(error)) {
            ...
            System.out.println("    Verify your image file is valid and not too large.");
