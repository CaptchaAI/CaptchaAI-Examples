# Driver License Portal CAPTCHA Test Automation
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/driver-license-portal-captcha-test-automation
   ```
...
- Make sure `.env` file is in the `articles/driver-license-portal-captcha-test-automation/` directory (not inside a language folder)
