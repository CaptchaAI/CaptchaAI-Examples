# Monitoring CaptchaAI Health With BetterStack
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/observability-betterstack-uptime-captchaai
   ```
...
- Make sure `.env` file is in the `articles/observability-betterstack-uptime-captchaai/` directory (not inside a language folder)
