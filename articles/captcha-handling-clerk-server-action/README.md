# Pairing CaptchaAI With a Clerk Server Action
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-clerk-server-action
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-clerk-server-action/` directory (not inside a language folder)
