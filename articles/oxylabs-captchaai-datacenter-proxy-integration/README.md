...
**[Oxylabs + CaptchaAI: Datacenter Proxy Integration](https://blog.captchaai.com/oxylabs-captchaai-datacenter-proxy-integration)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/oxylabs-captchaai-datacenter-proxy-integration
   ```
