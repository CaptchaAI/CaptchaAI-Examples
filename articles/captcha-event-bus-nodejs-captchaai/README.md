# Building a CAPTCHA Solve Event Bus with Node.js and CaptchaAI
...
**[Building a CAPTCHA Solve Event Bus with Node.js and CaptchaAI](https://blog.captchaai.com/captcha-event-bus-nodejs-captchaai)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-event-bus-nodejs-captchaai
   ```
