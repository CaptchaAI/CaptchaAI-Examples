...
**[ParseHub + CaptchaAI: No-Code Scraping with CAPTCHA Solving](https://blog.captchaai.com/parsehub-captchaai-no-code-scraping)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/parsehub-captchaai-no-code-scraping
   ```
