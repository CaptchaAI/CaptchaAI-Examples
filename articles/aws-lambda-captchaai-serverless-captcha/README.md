...
**[AWS Lambda + CaptchaAI: Serverless CAPTCHA Solving](https://blog.captchaai.com/aws-lambda-captchaai-serverless-captcha)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/aws-lambda-captchaai-serverless-captcha
   ```
