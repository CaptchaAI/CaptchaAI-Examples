# Solving CAPTCHAs From a Softr Custom Action
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-softr-noco
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-softr-noco/` directory (not inside a language folder)
