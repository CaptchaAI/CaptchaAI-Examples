# Residential vs ISP vs Mobile Proxies for CAPTCHA Solve Rate (2026)
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-solve-rate-residential-vs-isp-vs-mobile-2026
   ```
...
- Make sure `.env` file is in the `articles/captcha-solve-rate-residential-vs-isp-vs-mobile-2026/` directory (not inside a language folder)
