# Solving CAPTCHAs Inside Anthropic Computer-Use
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captcha-with-anthropic-computer-use
   ```
...
- Make sure `.env` file is in the `articles/solving-captcha-with-anthropic-computer-use/` directory (not inside a language folder)
