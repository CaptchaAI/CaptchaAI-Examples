# How AWS WAF Bot Control CAPTCHA Works
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-aws-waf-bot-control-captcha-works
   ```
...
- Make sure `.env` file is in the `articles/how-aws-waf-bot-control-captcha-works/` directory (not inside a language folder)
