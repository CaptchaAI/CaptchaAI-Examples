# Localizing CaptchaAI Extension Notification Prompts for Non-English Users
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-multi-language-prompts
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-multi-language-prompts/` directory (not inside a language folder)
