# Disaster Recovery Planning for CAPTCHA Solving Pipelines
...
**[Disaster Recovery Planning for CAPTCHA Solving Pipelines](https://blog.captchaai.com/disaster-recovery-captcha-solving-pipelines)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/disaster-recovery-captcha-solving-pipelines
   ```
