# Using the CaptchaAI Extension During 2FA Flows That Also Show CAPTCHA
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-2fa-flow-with-captcha
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-2fa-flow-with-captcha/` directory (not inside a language folder)
