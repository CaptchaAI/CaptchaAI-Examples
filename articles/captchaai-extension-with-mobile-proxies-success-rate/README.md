# Pairing the CaptchaAI Extension with Mobile Proxies for Higher Success
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-with-mobile-proxies-success-rate
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-with-mobile-proxies-success-rate/` directory (not inside a language folder)
