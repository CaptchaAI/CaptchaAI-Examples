...
**[How to Solve reCAPTCHA v3 Enterprise with PHP](https://blog.captchaai.com/solve-recaptcha-v3-enterprise-php)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solve-recaptcha-v3-enterprise-php
   ```
