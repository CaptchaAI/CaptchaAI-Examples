# Feature-Flagging the CaptchaAI Extension Across a Team
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-feature-flags-team-rollout
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-feature-flags-team-rollout/` directory (not inside a language folder)
