...
**[Go Goroutines + CaptchaAI: High-Throughput CAPTCHA Solving](https://blog.captchaai.com/go-goroutines-captchaai-high-throughput)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/go-goroutines-captchaai-high-throughput
   ```
