# Pairing CaptchaAI With Better-Auth Sign-In Flows
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-better-auth
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-better-auth/` directory (not inside a language folder)
