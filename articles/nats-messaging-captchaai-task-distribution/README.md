...
**[NATS Messaging + CaptchaAI: Lightweight CAPTCHA Task Distribution](https://blog.captchaai.com/nats-messaging-captchaai-task-distribution)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/nats-messaging-captchaai-task-distribution
   ```
