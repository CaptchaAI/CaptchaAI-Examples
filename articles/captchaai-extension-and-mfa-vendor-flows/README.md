# Using the CaptchaAI Extension Inside MFA-Protected Vendor Portals
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-and-mfa-vendor-flows
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-and-mfa-vendor-flows/` directory (not inside a language folder)
