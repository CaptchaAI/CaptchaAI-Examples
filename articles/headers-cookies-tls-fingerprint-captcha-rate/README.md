# Why Headers, Cookies, and TLS Fingerprint Affect Your CAPTCHA Solve Rate
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/headers-cookies-tls-fingerprint-captcha-rate
   ```
...
- Make sure `.env` file is in the `articles/headers-cookies-tls-fingerprint-captcha-rate/` directory (not inside a language folder)
