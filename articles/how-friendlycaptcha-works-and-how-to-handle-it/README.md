# How Friendly Captcha Works and How to Handle It
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-friendlycaptcha-works-and-how-to-handle-it
   ```
...
- Make sure `.env` file is in the `articles/how-friendlycaptcha-works-and-how-to-handle-it/` directory (not inside a language folder)
