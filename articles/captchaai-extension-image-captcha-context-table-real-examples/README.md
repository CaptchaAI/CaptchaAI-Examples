# Real-World Context Table Examples for Image CAPTCHA Pages
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-image-captcha-context-table-real-examples
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-image-captcha-context-table-real-examples/` directory (not inside a language folder)
