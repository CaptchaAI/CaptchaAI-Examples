# Solving CAPTCHAs With Cloudflare Queues
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-cloudflare-queues
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-cloudflare-queues/` directory (not inside a language folder)
