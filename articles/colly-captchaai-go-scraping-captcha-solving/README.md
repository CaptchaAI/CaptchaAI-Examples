...
**[Colly + CaptchaAI: Go-Based Scraping with CAPTCHA Solving](https://blog.captchaai.com/colly-captchaai-go-scraping-captcha-solving)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/colly-captchaai-go-scraping-captcha-solving
   ```
