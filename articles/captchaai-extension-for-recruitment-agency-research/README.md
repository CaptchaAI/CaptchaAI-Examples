# The CaptchaAI Extension for Recruitment-Agency Research Workflows
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-for-recruitment-agency-research
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-for-recruitment-agency-research/` directory (not inside a language folder)
