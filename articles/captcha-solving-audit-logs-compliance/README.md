...
**[CAPTCHA Solving Audit Logs: Tracking Solve Requests for Compliance](https://blog.captchaai.com/captcha-solving-audit-logs-compliance)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-solving-audit-logs-compliance
   ```
