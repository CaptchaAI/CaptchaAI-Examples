# Observability for CAPTCHA Pipelines With OpenTelemetry (2026)
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/observability-captcha-pipelines-otel-2026
   ```
...
- Make sure `.env` file is in the `articles/observability-captcha-pipelines-otel-2026/` directory (not inside a language folder)
