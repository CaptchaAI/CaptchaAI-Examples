...
**[Streaming Batch Results: Processing CAPTCHA Solutions as They Arrive](https://blog.captchaai.com/streaming-batch-captcha-results-processing)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/streaming-batch-captcha-results-processing
   ```
