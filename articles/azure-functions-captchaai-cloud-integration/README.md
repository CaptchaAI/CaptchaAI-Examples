...
**[Azure Functions + CaptchaAI: Cloud Integration](https://blog.captchaai.com/azure-functions-captchaai-cloud-integration)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/azure-functions-captchaai-cloud-integration
   ```
