...
**[Handling Multiple CAPTCHAs on a Single Page](https://blog.captchaai.com/handling-multiple-captchas-single-page)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/handling-multiple-captchas-single-page
   ```
