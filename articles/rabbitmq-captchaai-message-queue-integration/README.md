...
**[RabbitMQ + CaptchaAI: Message Queue Integration](https://blog.captchaai.com/rabbitmq-captchaai-message-queue-integration)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/rabbitmq-captchaai-message-queue-integration
   ```
