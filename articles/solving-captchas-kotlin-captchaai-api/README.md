...
**[Solving CAPTCHAs with Kotlin and CaptchaAI API](https://blog.captchaai.com/solving-captchas-kotlin-captchaai-api)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captchas-kotlin-captchaai-api
   ```
