# The CaptchaAI Extension for BLS Government Portal Staff
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-for-bls-government-portal-staff
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-for-bls-government-portal-staff/` directory (not inside a language folder)
