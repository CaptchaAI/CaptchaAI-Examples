...
**[Ad Verification Workflows with CAPTCHA Handling](https://blog.captchaai.com/ad-verification-captcha-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/ad-verification-captcha-handling
   ```
