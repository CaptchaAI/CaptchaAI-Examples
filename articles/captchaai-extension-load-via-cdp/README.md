# Loading the CaptchaAI Extension via Chrome DevTools Protocol
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-load-via-cdp
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-load-via-cdp/` directory (not inside a language folder)
