# BLS Auto-Open and Auto-Submit in the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-bls-auto-open-auto-submit
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-bls-auto-open-auto-submit/` directory (not inside a language folder)
