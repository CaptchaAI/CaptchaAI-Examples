# A Shared Config File So Multiple Workstations Use the Same CaptchaAI Extension Settings
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-source-of-truth-shared-config
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-source-of-truth-shared-config/` directory (not inside a language folder)
