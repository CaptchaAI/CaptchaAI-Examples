...
**[Solving CAPTCHAs with Perl and CaptchaAI API](https://blog.captchaai.com/solving-captchas-perl-captchaai-api)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captchas-perl-captchaai-api
   ```
