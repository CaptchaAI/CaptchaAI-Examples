# Solving CAPTCHAs From an Encore.ts Resource
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-encore-ts-resource
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-encore-ts-resource/` directory (not inside a language folder)
