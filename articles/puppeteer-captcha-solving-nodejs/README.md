...
**[Puppeteer CAPTCHA Solving with Node.js and CaptchaAI](https://blog.captchaai.com/puppeteer-captcha-solving-nodejs)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/puppeteer-captcha-solving-nodejs
   ```
