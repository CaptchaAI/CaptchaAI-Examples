...
**[CaptchaAI API Latency Optimization: Faster Solves](https://blog.captchaai.com/captchaai-api-latency-optimization)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-api-latency-optimization
   ```
