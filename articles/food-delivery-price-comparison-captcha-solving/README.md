...
**[Food Delivery Price Comparison with CAPTCHA Solving](https://blog.captchaai.com/food-delivery-price-comparison-captcha-solving)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/food-delivery-price-comparison-captcha-solving
   ```
