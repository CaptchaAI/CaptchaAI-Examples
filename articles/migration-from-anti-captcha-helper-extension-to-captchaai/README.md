# Migrating From the Anti-Captcha Helper Extension to the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/migration-from-anti-captcha-helper-extension-to-captchaai
   ```
...
- Make sure `.env` file is in the `articles/migration-from-anti-captcha-helper-extension-to-captchaai/` directory (not inside a language folder)
