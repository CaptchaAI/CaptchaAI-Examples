# Sports-Betting Odds Monitoring CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/sports-betting-odds-monitoring-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/sports-betting-odds-monitoring-captcha-handling/` directory (not inside a language folder)
