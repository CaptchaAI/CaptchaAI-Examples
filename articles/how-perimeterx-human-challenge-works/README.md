# How PerimeterX (HUMAN) Challenge Works
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-perimeterx-human-challenge-works
   ```
...
- Make sure `.env` file is in the `articles/how-perimeterx-human-challenge-works/` directory (not inside a language folder)
