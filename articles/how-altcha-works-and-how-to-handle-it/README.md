# How ALTCHA Works and How to Handle It
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-altcha-works-and-how-to-handle-it
   ```
...
- Make sure `.env` file is in the `articles/how-altcha-works-and-how-to-handle-it/` directory (not inside a language folder)
