...
**[reCAPTCHA v3 Action Parameter Explained](https://blog.captchaai.com/recaptcha-v3-action-parameter-explained)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/recaptcha-v3-action-parameter-explained
   ```
