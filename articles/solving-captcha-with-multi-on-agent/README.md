# Solving CAPTCHAs Inside MultiOn Web Agents
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captcha-with-multi-on-agent
   ```
...
- Make sure `.env` file is in the `articles/solving-captcha-with-multi-on-agent/` directory (not inside a language folder)
