...
**[Solving CAPTCHAs with Swift and CaptchaAI API](https://blog.captchaai.com/solving-captchas-swift-captchaai-api)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captchas-swift-captchaai-api
   ```
