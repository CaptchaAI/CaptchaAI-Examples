# Using the CaptchaAI Extension Inside a Citrix VDI Session
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-with-citrix-vdi-flows
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-with-citrix-vdi-flows/` directory (not inside a language folder)
