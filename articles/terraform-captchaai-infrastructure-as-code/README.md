# Terraform + CaptchaAI: Infrastructure as Code for CAPTCHA Workers
...
**[Terraform + CaptchaAI: Infrastructure as Code for CAPTCHA Workers](https://blog.captchaai.com/terraform-captchaai-infrastructure-as-code)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/terraform-captchaai-infrastructure-as-code
   ```
