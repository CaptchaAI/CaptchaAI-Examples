# How FingerprintJS Bot Detection Works
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-fingerprintjs-bot-detection-works
   ```
...
- Make sure `.env` file is in the `articles/how-fingerprintjs-bot-detection-works/` directory (not inside a language folder)
