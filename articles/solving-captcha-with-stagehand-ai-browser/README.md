# Solving CAPTCHAs with Stagehand AI Browser Automation
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captcha-with-stagehand-ai-browser
   ```
...
- Make sure `.env` file is in the `articles/solving-captcha-with-stagehand-ai-browser/` directory (not inside a language folder)
