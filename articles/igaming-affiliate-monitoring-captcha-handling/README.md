# iGaming Affiliate Monitoring CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/igaming-affiliate-monitoring-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/igaming-affiliate-monitoring-captcha-handling/` directory (not inside a language folder)
