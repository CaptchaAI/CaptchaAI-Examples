# Solving CAPTCHAs Behind Supabase RLS-Protected Pages
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-supabase-rls-protected-pages
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-supabase-rls-protected-pages/` directory (not inside a language folder)
