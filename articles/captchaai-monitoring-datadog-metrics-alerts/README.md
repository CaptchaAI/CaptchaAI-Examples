...
**[CaptchaAI Monitoring with Datadog: Metrics and Alerts](https://blog.captchaai.com/captchaai-monitoring-datadog-metrics-alerts)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-monitoring-datadog-metrics-alerts
   ```
