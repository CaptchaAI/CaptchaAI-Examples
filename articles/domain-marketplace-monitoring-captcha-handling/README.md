# Domain Marketplace Monitoring With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/domain-marketplace-monitoring-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/domain-marketplace-monitoring-captcha-handling/` directory (not inside a language folder)
