...
**[reCAPTCHA in Single Page Applications: Dynamic Loading Patterns](https://blog.captchaai.com/recaptcha-single-page-application-dynamic)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/recaptcha-single-page-application-dynamic
   ```
