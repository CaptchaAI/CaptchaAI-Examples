# Storing CaptchaAI API Keys in Azure Key Vault
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/security-azure-key-vault-captchaai
   ```
...
- Make sure `.env` file is in the `articles/security-azure-key-vault-captchaai/` directory (not inside a language folder)
