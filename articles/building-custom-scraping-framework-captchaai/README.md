...
**[Building a Custom Scraping Framework with CaptchaAI](https://blog.captchaai.com/building-custom-scraping-framework-captchaai)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/building-custom-scraping-framework-captchaai
   ```
