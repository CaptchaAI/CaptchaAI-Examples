# Immigration Portal Booking Workflows With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/immigration-portal-bookings-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/immigration-portal-bookings-captcha-handling/` directory (not inside a language folder)
