# Calling CaptchaAI From a Defer.run Job
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-defer-run-jobs
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-defer-run-jobs/` directory (not inside a language folder)
