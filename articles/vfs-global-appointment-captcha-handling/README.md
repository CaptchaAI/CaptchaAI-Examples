# VFS Global Appointment CAPTCHA Handling for Authorized Staff
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/vfs-global-appointment-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/vfs-global-appointment-captcha-handling/` directory (not inside a language folder)
