...
**[CAPTCHA Solving for API Endpoint Testing in Web Forms](https://blog.captchaai.com/captcha-solving-api-endpoint-testing-web-forms)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-solving-api-endpoint-testing-web-forms
   ```
