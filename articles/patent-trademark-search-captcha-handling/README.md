# Patent and Trademark Search Portal CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/patent-trademark-search-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/patent-trademark-search-captcha-handling/` directory (not inside a language folder)
