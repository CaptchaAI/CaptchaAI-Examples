# CaptchaAI Extension vs 2Captcha Solver Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-vs-2captcha-solver-extension
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-vs-2captcha-solver-extension/` directory (not inside a language folder)
