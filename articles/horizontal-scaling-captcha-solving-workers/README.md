...
**[Horizontal Scaling CAPTCHA Solving Workers: When and How](https://blog.captchaai.com/horizontal-scaling-captcha-solving-workers)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/horizontal-scaling-captcha-solving-workers
   ```
