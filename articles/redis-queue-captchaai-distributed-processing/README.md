...
**[Redis Queue + CaptchaAI: Distributed CAPTCHA Processing](https://blog.captchaai.com/redis-queue-captchaai-distributed-processing)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/redis-queue-captchaai-distributed-processing
   ```
