...
**[MongoDB for CAPTCHA Solve History and Analytics](https://blog.captchaai.com/mongodb-captcha-solve-history-analytics)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/mongodb-captcha-solve-history-analytics
   ```
