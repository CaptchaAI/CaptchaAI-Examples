# CaptchaAI Extension vs Zapier-Style Low-Code in 2026
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-vs-low-code-zapier-extension-2026
   ```
...
- Make sure `.env` file is in the `articles/captchaai-vs-low-code-zapier-extension-2026/` directory (not inside a language folder)
