...
**[Build a Multi-Site Data Aggregation System with CaptchaAI](https://blog.captchaai.com/build-multi-site-data-aggregation-captchaai)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/build-multi-site-data-aggregation-captchaai
   ```
