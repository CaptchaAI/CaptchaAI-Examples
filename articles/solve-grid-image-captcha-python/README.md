...
**[Solve Grid Image CAPTCHA with Python and CaptchaAI](https://blog.captchaai.com/solve-grid-image-captcha-python)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solve-grid-image-captcha-python
   ```
