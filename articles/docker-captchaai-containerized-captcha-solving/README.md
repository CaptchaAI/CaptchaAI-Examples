...
**[Docker + CaptchaAI: Containerized CAPTCHA Solving](https://blog.captchaai.com/docker-captchaai-containerized-captcha-solving)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/docker-captchaai-containerized-captcha-solving
   ```
