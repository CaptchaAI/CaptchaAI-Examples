...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-graphile-worker-postgres
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-graphile-worker-postgres/` directory (not inside a language folder)
