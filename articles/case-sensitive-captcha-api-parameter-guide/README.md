...
**[Case-Sensitive CAPTCHA API Parameter Guide](https://blog.captchaai.com/case-sensitive-captcha-api-parameter-guide)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/case-sensitive-captcha-api-parameter-guide
   ```
