# How NetEase Easy Captcha Works
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-netease-easy-captcha-works
   ```
...
- Make sure `.env` file is in the `articles/how-netease-easy-captcha-works/` directory (not inside a language folder)
