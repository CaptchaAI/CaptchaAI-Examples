# Kubernetes Job Queues for CAPTCHA Solving at Scale
...
**[Kubernetes Job Queues for CAPTCHA Solving at Scale](https://blog.captchaai.com/kubernetes-job-queues-captcha-solving-scale)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/kubernetes-job-queues-captcha-solving-scale
   ```
