# SERP Feature Monitoring With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/serp-feature-monitoring-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/serp-feature-monitoring-captcha-handling/` directory (not inside a language folder)
