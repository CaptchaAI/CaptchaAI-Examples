...
**[Health Check Endpoints for CAPTCHA Solving Workers](https://blog.captchaai.com/health-check-endpoints-captcha-workers)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/health-check-endpoints-captcha-workers
   ```
