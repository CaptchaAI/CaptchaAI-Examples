# The Complete Guide to the CaptchaAI Chrome Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-chrome-extension-complete-guide
   ```
...
- Make sure `.env` file is in the `articles/captchaai-chrome-extension-complete-guide/` directory (not inside a language folder)
