# Browser Console CAPTCHA Detection: Finding Sitekeys and Parameters
...
**[Browser Console CAPTCHA Detection: Finding Sitekeys and Parameters](https://blog.captchaai.com/browser-console-captcha-detection-sitekeys-parameters)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/browser-console-captcha-detection-sitekeys-parameters
   ```
