...
**[CaptchaAI Soft ID and Referral Tracking Integration](https://blog.captchaai.com/captchaai-soft-id-referral-tracking)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-soft-id-referral-tracking
   ```
