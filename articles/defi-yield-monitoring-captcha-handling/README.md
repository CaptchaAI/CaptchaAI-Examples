# DeFi Yield Monitoring With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/defi-yield-monitoring-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/defi-yield-monitoring-captcha-handling/` directory (not inside a language folder)
