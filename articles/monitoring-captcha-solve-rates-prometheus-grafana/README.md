...
**[Monitoring CAPTCHA Solve Rates with Prometheus and Grafana](https://blog.captchaai.com/monitoring-captcha-solve-rates-prometheus-grafana)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/monitoring-captcha-solve-rates-prometheus-grafana
   ```
