...
**[Proxy Authentication Methods for CaptchaAI API](https://blog.captchaai.com/proxy-authentication-methods-captchaai)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/proxy-authentication-methods-captchaai
   ```
