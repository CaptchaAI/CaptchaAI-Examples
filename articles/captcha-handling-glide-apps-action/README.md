# Calling CaptchaAI From a Glide Apps Action
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-glide-apps-action
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-glide-apps-action/` directory (not inside a language folder)
