# Install and Set Up the CaptchaAI Chrome Extension in 5 Minutes
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-install-setup-5-minutes
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-install-setup-5-minutes/` directory (not inside a language folder)
