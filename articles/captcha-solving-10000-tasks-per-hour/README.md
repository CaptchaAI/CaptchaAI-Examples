...
**[CAPTCHA Solving Throughput: How to Process 10,000 Tasks per Hour](https://blog.captchaai.com/captcha-solving-10000-tasks-per-hour)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-solving-10000-tasks-per-hour
   ```
