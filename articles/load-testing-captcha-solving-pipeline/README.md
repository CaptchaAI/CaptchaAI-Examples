...
**[Load Testing Your CAPTCHA Solving Pipeline with CaptchaAI](https://blog.captchaai.com/load-testing-captcha-solving-pipeline)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/load-testing-captcha-solving-pipeline
   ```
