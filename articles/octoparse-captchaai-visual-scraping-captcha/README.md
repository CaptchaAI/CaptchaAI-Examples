...
**[Octoparse + CaptchaAI: Visual Scraping with CAPTCHA Handling](https://blog.captchaai.com/octoparse-captchaai-visual-scraping-captcha)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/octoparse-captchaai-visual-scraping-captcha
   ```
