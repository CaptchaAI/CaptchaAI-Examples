...
**[Batch reCAPTCHA Solving for Form Submission Pipelines](https://blog.captchaai.com/batch-recaptcha-solving-form-pipelines)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/batch-recaptcha-solving-form-pipelines
   ```
