...
**[Discord Webhook Alerts for CAPTCHA Pipeline Status](https://blog.captchaai.com/discord-webhook-captcha-pipeline-alerts)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/discord-webhook-captcha-pipeline-alerts
   ```
