...
**[Storing CAPTCHA Solve Results in PostgreSQL](https://blog.captchaai.com/storing-captcha-results-postgresql)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/storing-captcha-results-postgresql
   ```
