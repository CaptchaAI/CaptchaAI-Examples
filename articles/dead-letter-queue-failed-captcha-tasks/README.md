# Dead-Letter Queue for Failed CAPTCHA Tasks
...
**[Dead-Letter Queue for Failed CAPTCHA Tasks](https://blog.captchaai.com/dead-letter-queue-failed-captcha-tasks)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/dead-letter-queue-failed-captcha-tasks
   ```
