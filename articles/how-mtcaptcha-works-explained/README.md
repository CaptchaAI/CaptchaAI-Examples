...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-mtcaptcha-works-explained
   ```
...
- Make sure `.env` file is in the `articles/how-mtcaptcha-works-explained/` directory (not inside a language folder)
