# hCaptcha — CaptchaAI Example Pack

Full working example for solving hCaptcha using the CaptchaAI API.
...
**[How to Solve hCaptcha Using API](https://blog.captchaai.com/how-to-solve-hcaptcha-using-api)**

## Prerequisites

- A CaptchaAI account with API key ([get one here](https://captchaai.com))
- A target page with hCaptcha for testing
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-to-solve-hcaptcha-using-api
   ```
...
| `CAPTCHA_SITEKEY` | hCaptcha sitekey from the target page |
