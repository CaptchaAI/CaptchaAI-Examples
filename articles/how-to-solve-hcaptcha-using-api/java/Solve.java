...
public class Solve {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (sitekey.isEmpty() || sitekey.equals("YOUR_SITE_KEY")) {
            ...
            System.out.println("    Add the hCaptcha sitekey from your target page to .env");
            System.exit(1);
        }
        ...
        // Submit task
        System.out.println("[*] Submitting hCaptcha task...");
        String submitParams = String.format(
            "key=%s&method=hcaptcha&sitekey=%s&pageurl=%s&json=1",
        ...
        while (elapsed < maxTimeout) {
            ...
            if (status == 1) {
                ...
                System.out.println("h-captcha-response hidden field and submit the form.");
                return;
            }
