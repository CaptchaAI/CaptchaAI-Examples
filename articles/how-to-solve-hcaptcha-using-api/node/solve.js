...
function validateConfig() {
  ...
  if (!CAPTCHA_SITEKEY || CAPTCHA_SITEKEY === "YOUR_SITE_KEY") {
    ...
    console.log("    Add the hCaptcha sitekey from your target page to .env");
    process.exit(1);
  }
...
async function submitTask() {
  console.log("[*] Submitting hCaptcha task...");
...
async function main() {
  ...
  console.log("h-captcha-response hidden field and submit the form.");
}
