...
**[Debugging CAPTCHA API Calls with Charles Proxy](https://blog.captchaai.com/debugging-captcha-api-charles-proxy)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/debugging-captcha-api-charles-proxy
   ```
