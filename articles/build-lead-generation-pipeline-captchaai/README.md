...
**[Build a Lead Generation Pipeline with CaptchaAI](https://blog.captchaai.com/build-lead-generation-pipeline-captchaai)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/build-lead-generation-pipeline-captchaai
   ```
