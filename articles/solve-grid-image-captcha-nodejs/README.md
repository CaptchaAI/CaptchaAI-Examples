...
**[Solve Grid Image CAPTCHA with Node.js and CaptchaAI](https://blog.captchaai.com/solve-grid-image-captcha-nodejs)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solve-grid-image-captcha-nodejs
   ```
