...
**[Zapier + CaptchaAI: No-Code CAPTCHA Solving Automation](https://blog.captchaai.com/zapier-captchaai-no-code-automation)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/zapier-captchaai-no-code-automation
   ```
