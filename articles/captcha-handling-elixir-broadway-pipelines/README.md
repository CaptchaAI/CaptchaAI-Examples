...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-elixir-broadway-pipelines
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-elixir-broadway-pipelines/` directory (not inside a language folder)
