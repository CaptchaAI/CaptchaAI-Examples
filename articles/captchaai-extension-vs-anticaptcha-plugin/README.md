# CaptchaAI Extension vs Anti-Captcha Plugin
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-vs-anticaptcha-plugin
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-vs-anticaptcha-plugin/` directory (not inside a language folder)
