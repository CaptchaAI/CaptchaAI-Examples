# Pin the CaptchaAI Extension to the Chrome Toolbar for Faster Access
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-pin-toolbar-faster-access
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-pin-toolbar-faster-access/` directory (not inside a language folder)
