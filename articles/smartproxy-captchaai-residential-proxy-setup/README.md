# Smartproxy + CaptchaAI: Residential Proxy Setup for CAPTCHA Solving
...
**[Smartproxy + CaptchaAI: Residential Proxy Setup for CAPTCHA Solving](https://blog.captchaai.com/smartproxy-captchaai-residential-proxy-setup)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/smartproxy-captchaai-residential-proxy-setup
   ```
