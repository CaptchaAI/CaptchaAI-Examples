...
**[How to Solve reCAPTCHA v2 Enterprise with Python](https://blog.captchaai.com/solve-recaptcha-v2-enterprise-python)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solve-recaptcha-v2-enterprise-python
   ```
