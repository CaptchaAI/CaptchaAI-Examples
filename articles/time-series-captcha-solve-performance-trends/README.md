...
**[Time-Series Data for CAPTCHA Solve Performance Trends](https://blog.captchaai.com/time-series-captcha-solve-performance-trends)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/time-series-captcha-solve-performance-trends
   ```
