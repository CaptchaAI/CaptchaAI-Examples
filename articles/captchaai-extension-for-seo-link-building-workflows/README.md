# Using the CaptchaAI Extension in SEO Link-Building Workflows
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-for-seo-link-building-workflows
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-for-seo-link-building-workflows/` directory (not inside a language folder)
