...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-yandex-smartcaptcha-works
   ```
...
- Make sure `.env` file is in the `articles/how-yandex-smartcaptcha-works/` directory (not inside a language folder)
