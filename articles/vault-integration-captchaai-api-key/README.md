...
**[Vault Integration for CaptchaAI API Key Management](https://blog.captchaai.com/vault-integration-captchaai-api-key)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/vault-integration-captchaai-api-key
   ```
