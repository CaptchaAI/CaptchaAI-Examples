# Using CaptchaAI Inside an Airbyte Source for LLM Data Pipelines
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/llm-data-pipeline-captchaai-airbyte
   ```
...
- Make sure `.env` file is in the `articles/llm-data-pipeline-captchaai-airbyte/` directory (not inside a language folder)
