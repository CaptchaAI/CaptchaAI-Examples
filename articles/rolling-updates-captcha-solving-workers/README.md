...
**[Rolling Updates for CAPTCHA Solving Worker Fleets](https://blog.captchaai.com/rolling-updates-captcha-solving-workers)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/rolling-updates-captcha-solving-workers
   ```
