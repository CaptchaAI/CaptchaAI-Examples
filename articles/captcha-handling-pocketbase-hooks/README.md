# Solving CAPTCHAs From PocketBase JavaScript Hooks
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-pocketbase-hooks
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-pocketbase-hooks/` directory (not inside a language folder)
