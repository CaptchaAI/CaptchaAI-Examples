...
**[BLS CAPTCHA in Government Portals: Handling Strategies](https://blog.captchaai.com/bls-captcha-government-portals-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/bls-captcha-government-portals-handling
   ```
