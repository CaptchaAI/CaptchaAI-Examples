# Pairing CaptchaAI With Auth.js (NextAuth) Credentials Providers
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-auth-js-credentials-provider
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-auth-js-credentials-provider/` directory (not inside a language folder)
