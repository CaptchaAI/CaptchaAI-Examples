...
**[Social Media Research Data Collection with CAPTCHA Handling](https://blog.captchaai.com/social-media-research-captcha-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/social-media-research-captcha-handling
   ```
