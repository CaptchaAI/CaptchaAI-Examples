...
**[CaptchaAI Python Client with Pydantic Validation](https://blog.captchaai.com/captchaai-python-pydantic-validation)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-python-pydantic-validation
   ```
