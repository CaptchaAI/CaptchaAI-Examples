# The CaptchaAI Extension Is Not Solving: Step-by-Step Checklist
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-not-solving-checklist
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-not-solving-checklist/` directory (not inside a language folder)
