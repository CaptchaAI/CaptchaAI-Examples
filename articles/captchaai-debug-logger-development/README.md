...
**[Building a CaptchaAI Debug Logger for Development](https://blog.captchaai.com/captchaai-debug-logger-development)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-debug-logger-development
   ```
