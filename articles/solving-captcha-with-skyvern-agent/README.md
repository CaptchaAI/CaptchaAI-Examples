# Solving CAPTCHAs Inside Skyvern Browser Agents
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solving-captcha-with-skyvern-agent
   ```
...
- Make sure `.env` file is in the `articles/solving-captcha-with-skyvern-agent/` directory (not inside a language folder)
