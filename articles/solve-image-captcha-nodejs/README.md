...
**[Solve Image CAPTCHA with Node.js and CaptchaAI](https://blog.captchaai.com/solve-image-captcha-nodejs)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/solve-image-captcha-nodejs
   ```
