# Tracing CaptchaAI Calls in Baselime
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/observability-baselime-captchaai
   ```
...
- Make sure `.env` file is in the `articles/observability-baselime-captchaai/` directory (not inside a language folder)
