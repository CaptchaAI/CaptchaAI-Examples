# Solving CAPTCHAs Across Multiple Pinned Tabs with the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-pin-multiple-tabs-parallel-solving
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-pin-multiple-tabs-parallel-solving/` directory (not inside a language folder)
