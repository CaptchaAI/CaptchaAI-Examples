# Solving CAPTCHAs Inside an Encore.go Microservice
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-encore-go-microservice
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-encore-go-microservice/` directory (not inside a language folder)
