# Using the CaptchaAI Extension as a Fallback When the API Degrades
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-as-fallback-when-api-degrades
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-as-fallback-when-api-degrades/` directory (not inside a language folder)
