...
**[Building a Python Wrapper Library for CaptchaAI API](https://blog.captchaai.com/python-wrapper-library-captchaai-api)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/python-wrapper-library-captchaai-api
   ```
