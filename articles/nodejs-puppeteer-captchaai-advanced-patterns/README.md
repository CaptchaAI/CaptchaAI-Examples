# Node.js Puppeteer + CaptchaAI Advanced Patterns
...
**[Node.js Puppeteer + CaptchaAI Advanced Patterns](https://blog.captchaai.com/nodejs-puppeteer-captchaai-advanced-patterns)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/nodejs-puppeteer-captchaai-advanced-patterns
   ```
