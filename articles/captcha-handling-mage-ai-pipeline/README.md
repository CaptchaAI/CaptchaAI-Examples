# Calling CaptchaAI From a Mage.ai Pipeline
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-mage-ai-pipeline
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-mage-ai-pipeline/` directory (not inside a language folder)
