# Extension vs Cloud Emulator vs API: 2026 Decision Tree
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-vs-cloud-emulator-vs-api-decision-2026
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-vs-cloud-emulator-vs-api-decision-2026/` directory (not inside a language folder)
