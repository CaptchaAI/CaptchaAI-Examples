# CaptchaAI Extension Plus CLI: A Hybrid Workflow
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-cli-companion-future
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-cli-companion-future/` directory (not inside a language folder)
