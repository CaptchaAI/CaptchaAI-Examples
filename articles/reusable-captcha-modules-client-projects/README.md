...
**[Reusable CAPTCHA Modules for Client Projects](https://blog.captchaai.com/reusable-captcha-modules-client-projects)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/reusable-captcha-modules-client-projects
   ```
