...
**[Extracting reCAPTCHA Parameters from Page Source](https://blog.captchaai.com/extracting-recaptcha-parameters-page-source)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/extracting-recaptcha-parameters-page-source
   ```
