...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-edge-runtime-vercel
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-edge-runtime-vercel/` directory (not inside a language folder)
