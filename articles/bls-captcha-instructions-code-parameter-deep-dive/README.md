...
**[BLS CAPTCHA Instructions and Code Parameter Deep Dive](https://blog.captchaai.com/bls-captcha-instructions-code-parameter-deep-dive)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/bls-captcha-instructions-code-parameter-deep-dive
   ```
...
1. **Submit** â€” Sends the CAPTCHA parameters to `https://ocr.captchaai.com/in.php` using method `bls`
