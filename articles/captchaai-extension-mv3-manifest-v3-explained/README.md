# The CaptchaAI Extension and Chrome Manifest V3
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-mv3-manifest-v3-explained
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-mv3-manifest-v3-explained/` directory (not inside a language folder)
