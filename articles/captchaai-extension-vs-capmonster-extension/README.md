# CaptchaAI Extension vs CapMonster Cloud Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-vs-capmonster-extension
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-vs-capmonster-extension/` directory (not inside a language folder)
