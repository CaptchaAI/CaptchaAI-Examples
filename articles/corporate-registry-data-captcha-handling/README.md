# Corporate Registry Data Pulls With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/corporate-registry-data-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/corporate-registry-data-captcha-handling/` directory (not inside a language folder)
