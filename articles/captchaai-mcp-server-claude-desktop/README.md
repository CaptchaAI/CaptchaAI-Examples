# Connecting a CaptchaAI MCP Server to Claude Desktop
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-mcp-server-claude-desktop
   ```
...
- Make sure `.env` file is in the `articles/captchaai-mcp-server-claude-desktop/` directory (not inside a language folder)
