# Pairing CaptchaAI With Auth0 Actions
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-auth0-actions
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-auth0-actions/` directory (not inside a language folder)
