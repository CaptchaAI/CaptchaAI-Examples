# CaptchaAI Extension vs API: When to Use Each
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-vs-api-when-to-use-each
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-vs-api-when-to-use-each/` directory (not inside a language folder)
