...
public class Solve {
    ...
    public Solve(Map<String, String> env) {
        ...
        this.proxy = env.getOrDefault("PROXY", "");
        this.proxytype = env.getOrDefault("PROXYTYPE", "HTTP");
    ...
    private String submitTask() {
        ...
        String params = String.format(
            ...
            URLEncoder.encode(proxy, java.nio.charset.StandardCharsets.UTF_8),
            URLEncoder.encode(proxytype, java.nio.charset.StandardCharsets.UTF_8));
    ...
    private String pollResult(String taskId) {
        ...
        int elapsed = 20, attempt = 0, backoff = pollInterval;
