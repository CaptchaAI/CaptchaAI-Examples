...
**[Image CAPTCHA Confidence Scores: Using CaptchaAI Quality Metrics](https://blog.captchaai.com/image-captcha-confidence-scores-quality)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/image-captcha-confidence-scores-quality
   ```
