# Solving CAPTCHAs Inside AWS Step Functions Express
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-aws-stepfunctions-express
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-aws-stepfunctions-express/` directory (not inside a language folder)
