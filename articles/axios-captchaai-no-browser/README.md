...
**[Axios + CaptchaAI: Solve CAPTCHAs Without a Browser](https://blog.captchaai.com/axios-captchaai-no-browser)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/axios-captchaai-no-browser
   ```
