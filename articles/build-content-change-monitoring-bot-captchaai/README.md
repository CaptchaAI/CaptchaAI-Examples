...
**[Build a Content Change Monitoring Bot with CaptchaAI](https://blog.captchaai.com/build-content-change-monitoring-bot-captchaai)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/build-content-change-monitoring-bot-captchaai
   ```
