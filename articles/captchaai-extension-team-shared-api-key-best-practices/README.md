# Sharing One API Key with the CaptchaAI Extension Across a Small Team
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-team-shared-api-key-best-practices
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-team-shared-api-key-best-practices/` directory (not inside a language folder)
