# Migrate from NopeCHA to the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/migrate-nopecha-to-captchaai-extension
   ```
...
- Make sure `.env` file is in the `articles/migrate-nopecha-to-captchaai-extension/` directory (not inside a language folder)
