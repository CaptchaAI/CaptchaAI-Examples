# Chrome Extension CAPTCHA Solver Buyer Guide 2026
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/chrome-extension-captcha-solver-buyer-guide-2026
   ```
...
- Make sure `.env` file is in the `articles/chrome-extension-captcha-solver-buyer-guide-2026/` directory (not inside a language folder)
