...
**[Profiling CAPTCHA Solving Bottlenecks in Python Applications](https://blog.captchaai.com/profiling-captcha-bottlenecks-python)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/profiling-captcha-bottlenecks-python
   ```
