...
**[Retail Site Data Collection with CAPTCHA Handling](https://blog.captchaai.com/retail-site-captcha-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/retail-site-captcha-handling
   ```
