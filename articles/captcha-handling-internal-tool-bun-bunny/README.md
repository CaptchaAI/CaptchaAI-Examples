# A Minimal Internal Tool That Solves CAPTCHAs in 50 LOC (Bun + Hono)
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-internal-tool-bun-bunny
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-internal-tool-bun-bunny/` directory (not inside a language folder)
