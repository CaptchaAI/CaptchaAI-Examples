# Migrate from Buster to the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/migrate-buster-to-captchaai-extension
   ```
...
- Make sure `.env` file is in the `articles/migrate-buster-to-captchaai-extension/` directory (not inside a language folder)
