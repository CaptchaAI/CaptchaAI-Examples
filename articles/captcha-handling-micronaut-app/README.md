# Solving CAPTCHAs in a Micronaut App
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-micronaut-app
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-micronaut-app/` directory (not inside a language folder)
