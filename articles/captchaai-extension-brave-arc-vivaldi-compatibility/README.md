# Using the CaptchaAI Extension in Brave, Arc, and Vivaldi
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-brave-arc-vivaldi-compatibility
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-brave-arc-vivaldi-compatibility/` directory (not inside a language folder)
