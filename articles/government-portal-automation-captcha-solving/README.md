...
**[Government Portal Automation with CAPTCHA Solving](https://blog.captchaai.com/government-portal-automation-captcha-solving)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/government-portal-automation-captcha-solving
   ```
