...
**[BLS CAPTCHA Image Order and Grid Response Handling](https://blog.captchaai.com/bls-captcha-image-order-grid-response-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/bls-captcha-image-order-grid-response-handling
   ```
