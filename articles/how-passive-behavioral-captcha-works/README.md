# How Passive Behavioral CAPTCHAs Work
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-passive-behavioral-captcha-works
   ```
...
- Make sure `.env` file is in the `articles/how-passive-behavioral-captcha-works/` directory (not inside a language folder)
