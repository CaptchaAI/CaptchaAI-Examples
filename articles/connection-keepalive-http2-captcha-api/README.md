# Connection Keep-Alive and HTTP/2 for Faster CAPTCHA API Calls
...
**[Connection Keep-Alive and HTTP/2 for Faster CAPTCHA API Calls](https://blog.captchaai.com/connection-keepalive-http2-captcha-api)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/connection-keepalive-http2-captcha-api
   ```
