# Solving CAPTCHAs From Bunny.net Edge Scripting
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-bunny-edge-scripting
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-bunny-edge-scripting/` directory (not inside a language folder)
