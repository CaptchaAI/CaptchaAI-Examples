# Solving CAPTCHAs in an Elixir Phoenix App
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-elixir-phoenix
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-elixir-phoenix/` directory (not inside a language folder)
