# Authorized Passport Renewal Portal CAPTCHA Testing
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/passport-renewal-portal-captcha-testing
   ```
...
- Make sure `.env` file is in the `articles/passport-renewal-portal-captcha-testing/` directory (not inside a language folder)
