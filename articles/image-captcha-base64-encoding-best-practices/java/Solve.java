/**
 * Solve Image/OCR CAPTCHA using the CaptchaAI API.
 *
 * Usage:
 *   javac Solve.java
 *   java Solve
...
public class Solve {
    ...
    public Solve(Map<String, String> env) {
        ...
        this.body = env.getOrDefault("CAPTCHA_BODY", "");
    ...
    private String submitTask() {
        System.out.println("[*] Submitting Image/OCR CAPTCHA task...");
        String params = String.format(
            "key=%s&method=base64&body=%s&json=1",
            URLEncoder.encode(apiKey, java.nio.charset.StandardCharsets.UTF_8),
            URLEncoder.encode(body, java.nio.charset.StandardCharsets.UTF_8));
    ...
    private String pollResult(String taskId) {
        ...
        int elapsed = 10, attempt = 0, backoff = pollInterval;
