...
**[Node.js Promise.allSettled for Batch CAPTCHA Solving](https://blog.captchaai.com/nodejs-promise-allsettled-batch-captcha)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/nodejs-promise-allsettled-batch-captcha
   ```
