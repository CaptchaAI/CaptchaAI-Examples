# How WebGL-Fingerprint CAPTCHAs Work
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-webgl-fingerprint-captcha-works
   ```
...
- Make sure `.env` file is in the `articles/how-webgl-fingerprint-captcha-works/` directory (not inside a language folder)
