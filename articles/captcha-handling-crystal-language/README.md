# Solving CAPTCHAs from a Crystal HTTP Client
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-crystal-language
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-crystal-language/` directory (not inside a language folder)
