...
public class Solve {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (sitekey.isEmpty() || sitekey.equals("YOUR_SITE_KEY")) {
            ...
            System.out.println("    Add the reCAPTCHA v3 sitekey from your target page to .env");
            System.exit(1);
        }
        ...
        String submitParams = String.format(
            "key=%s&method=userrecaptcha&googlekey=%s&pageurl=%s&version=v3&action=%s&min_score=%s&json=1",
