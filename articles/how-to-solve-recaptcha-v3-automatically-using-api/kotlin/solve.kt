...
fun main() {
    ...
    val submitParams = "key=${enc(apiKey)}&method=userrecaptcha&googlekey=${enc(sitekey)}&pageurl=${enc(pageurl)}&version=v3&action=${enc(captchaAction)}&min_score=${enc(minScore)}&json=1"
