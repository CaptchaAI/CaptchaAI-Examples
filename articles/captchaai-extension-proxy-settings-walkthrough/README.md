# Proxy Settings in the CaptchaAI Extension: Walkthrough
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-proxy-settings-walkthrough
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-proxy-settings-walkthrough/` directory (not inside a language folder)
