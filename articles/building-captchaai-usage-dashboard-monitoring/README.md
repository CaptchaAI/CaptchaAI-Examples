...
**[Building a CaptchaAI Usage Dashboard and Monitoring](https://blog.captchaai.com/building-captchaai-usage-dashboard-monitoring)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/building-captchaai-usage-dashboard-monitoring
   ```
