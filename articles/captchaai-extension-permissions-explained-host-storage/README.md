# Chrome Permissions Requested by the CaptchaAI Extension Explained
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-permissions-explained-host-storage
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-permissions-explained-host-storage/` directory (not inside a language folder)
