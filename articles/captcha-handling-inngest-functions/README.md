# Calling CaptchaAI From an Inngest Background Function
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-inngest-functions
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-inngest-functions/` directory (not inside a language folder)
