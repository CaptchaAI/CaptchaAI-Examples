# Loading the CaptchaAI Extension in Playwright Persistent Context
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-with-playwright-persistent-context
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-with-playwright-persistent-context/` directory (not inside a language folder)
