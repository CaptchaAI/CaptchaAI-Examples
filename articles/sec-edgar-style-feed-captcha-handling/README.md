# SEC-EDGAR-Style Feed Workflows With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/sec-edgar-style-feed-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/sec-edgar-style-feed-captcha-handling/` directory (not inside a language folder)
