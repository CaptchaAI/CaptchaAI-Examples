# Solving Math CAPTCHAs Automatically with the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-auto-evaluate-math-captcha
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-auto-evaluate-math-captcha/` directory (not inside a language folder)
