# Solving CAPTCHAs in TanStack Start Server Functions
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-tanstack-start-server-functions
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-tanstack-start-server-functions/` directory (not inside a language folder)
