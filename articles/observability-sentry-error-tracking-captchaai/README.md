# Tracking CaptchaAI Errors in Sentry
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/observability-sentry-error-tracking-captchaai
   ```
...
- Make sure `.env` file is in the `articles/observability-sentry-error-tracking-captchaai/` directory (not inside a language folder)
