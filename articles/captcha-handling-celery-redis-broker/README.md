# Solving CAPTCHAs With Celery and Redis Broker
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-celery-redis-broker
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-celery-redis-broker/` directory (not inside a language folder)
