...
**[Rate Limiting Your Own CAPTCHA Solving Requests](https://blog.captchaai.com/rate-limiting-own-captcha-requests)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/rate-limiting-own-captcha-requests
   ```
