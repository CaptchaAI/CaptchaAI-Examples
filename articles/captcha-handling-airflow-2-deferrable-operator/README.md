...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-airflow-2-deferrable-operator
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-airflow-2-deferrable-operator/` directory (not inside a language folder)
