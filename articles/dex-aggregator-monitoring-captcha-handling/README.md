# DEX Aggregator Monitoring With CAPTCHA Handling
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/dex-aggregator-monitoring-captcha-handling
   ```
...
- Make sure `.env` file is in the `articles/dex-aggregator-monitoring-captcha-handling/` directory (not inside a language folder)
