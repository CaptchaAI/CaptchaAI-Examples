# CaptchaAI Extension vs NopeCHA Extension: Honest Comparison
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-vs-nopecha-extension
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-vs-nopecha-extension/` directory (not inside a language folder)
