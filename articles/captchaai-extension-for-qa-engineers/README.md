# The CaptchaAI Extension for QA Engineers Running Manual Test Sessions
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-for-qa-engineers
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-for-qa-engineers/` directory (not inside a language folder)
