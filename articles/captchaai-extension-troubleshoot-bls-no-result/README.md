# Extension Troubleshooting: BLS Solve Returns No Result
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-troubleshoot-bls-no-result
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-troubleshoot-bls-no-result/` directory (not inside a language folder)
