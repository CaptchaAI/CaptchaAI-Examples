# Claiming the Discord 100-Free-Threads Promo for the CaptchaAI Extension
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-discord-100-free-threads-promo
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-discord-100-free-threads-promo/` directory (not inside a language folder)
