...
**[CAPTCHA Solving for QA and Authorized Testing](https://blog.captchaai.com/captcha-solving-qa-authorized-testing)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-solving-qa-authorized-testing
   ```
