...
**[GeeTest Token Injection in Browser Automation Frameworks](https://blog.captchaai.com/geetest-token-injection-browser-automation)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/geetest-token-injection-browser-automation
   ```
...
1. **Submit** â€” Sends the CAPTCHA parameters to `https://ocr.captchaai.com/in.php` using method `geetest`
