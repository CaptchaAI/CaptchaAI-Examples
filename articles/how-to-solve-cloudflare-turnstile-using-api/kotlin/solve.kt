...
fun main() {
    ...
    if (sitekey.isEmpty() || sitekey == "YOUR_SITE_KEY") {
        ...
        println("    Add the Cloudflare Turnstile sitekey from your target page to .env")
        System.exit(1)
    }
    ...
    val submitParams = "key=${enc(apiKey)}&method=turnstile&sitekey=${enc(sitekey)}&pageurl=${enc(pageurl)}&json=1"
