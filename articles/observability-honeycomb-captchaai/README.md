# Tracing CaptchaAI Calls in Honeycomb
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/observability-honeycomb-captchaai
   ```
...
- Make sure `.env` file is in the `articles/observability-honeycomb-captchaai/` directory (not inside a language folder)
