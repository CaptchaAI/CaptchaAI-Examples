# Installing the CaptchaAI Extension in Microsoft Edge
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-edge-browser-installation
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-edge-browser-installation/` directory (not inside a language folder)
