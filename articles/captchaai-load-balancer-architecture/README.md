...
**[CaptchaAI Behind a Load Balancer: Architecture Patterns](https://blog.captchaai.com/captchaai-load-balancer-architecture)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-load-balancer-architecture
   ```
