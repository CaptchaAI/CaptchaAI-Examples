...
**[Building a CAPTCHA Solving Queue in Python with CaptchaAI](https://blog.captchaai.com/building-captcha-solving-queue-python)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/building-captcha-solving-queue-python
   ```
