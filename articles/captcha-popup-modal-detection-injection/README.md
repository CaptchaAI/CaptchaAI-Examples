...
**[CAPTCHA in Pop-Up Modals: Detection and Token Injection](https://blog.captchaai.com/captcha-popup-modal-detection-injection)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-popup-modal-detection-injection
   ```
