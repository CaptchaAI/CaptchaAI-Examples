# Solving CAPTCHAs With Fly Machines On-Demand Workers
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-fly-machines-on-demand
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-fly-machines-on-demand/` directory (not inside a language folder)
