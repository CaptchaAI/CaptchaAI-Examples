# CAPTCHA Handling for RAG-Pipeline Data Collection
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captcha-handling-for-rag-pipeline-data-collection
   ```
...
- Make sure `.env` file is in the `articles/captcha-handling-for-rag-pipeline-data-collection/` directory (not inside a language folder)
