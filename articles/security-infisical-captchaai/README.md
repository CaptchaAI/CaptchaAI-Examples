# Managing CaptchaAI Credentials With Infisical
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/security-infisical-captchaai
   ```
...
- Make sure `.env` file is in the `articles/security-infisical-captchaai/` directory (not inside a language folder)
