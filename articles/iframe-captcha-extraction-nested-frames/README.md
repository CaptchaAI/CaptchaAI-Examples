...
**[Iframe CAPTCHA Extraction: Solving CAPTCHAs in Nested Frames](https://blog.captchaai.com/iframe-captcha-extraction-nested-frames)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/iframe-captcha-extraction-nested-frames
   ```
