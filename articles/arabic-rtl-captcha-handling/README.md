# Arabic and RTL CAPTCHA Handling with CaptchaAI
...
**[Arabic and RTL CAPTCHA Handling with CaptchaAI](https://blog.captchaai.com/arabic-rtl-captcha-handling)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/arabic-rtl-captcha-handling
   ```
