# Batch CAPTCHA Solving: Submitting Multiple Tasks Efficiently
...
**[Batch CAPTCHA Solving: Submitting Multiple Tasks Efficiently](https://blog.captchaai.com/batch-captcha-solving-multiple-tasks)**
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/batch-captcha-solving-multiple-tasks
   ```
