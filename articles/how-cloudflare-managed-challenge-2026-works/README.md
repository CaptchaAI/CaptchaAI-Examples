# How the 2026 Cloudflare Managed Challenge Works
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/how-cloudflare-managed-challenge-2026-works
   ```
...
- Make sure `.env` file is in the `articles/how-cloudflare-managed-challenge-2026-works/` directory (not inside a language folder)
