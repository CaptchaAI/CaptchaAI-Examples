# Extension Troubleshooting: Turnstile Token Not Injected
...
1. Clone the repository:
   ...
   cd CaptchaAI-Examples/articles/captchaai-extension-troubleshoot-turnstile-token-not-injected
   ```
...
- Make sure `.env` file is in the `articles/captchaai-extension-troubleshoot-turnstile-token-not-injected/` directory (not inside a language folder)
