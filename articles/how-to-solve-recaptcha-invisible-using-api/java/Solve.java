...
public class Solve {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (sitekey.isEmpty() || sitekey.equals("YOUR_SITE_KEY")) {
            ...
            System.out.println("    Add the reCAPTCHA Invisible sitekey from your target page to .env");
            System.exit(1);
        }
        ...
        while (elapsed < maxTimeout) {
            ...
            if (status == 1) {
                ...
                System.out.println();
                System.out.println("Next step: inject this token via the page's data-callback function");
                System.out.println("or set the g-recaptcha-response hidden field and submit the form.");
                return;
            }
