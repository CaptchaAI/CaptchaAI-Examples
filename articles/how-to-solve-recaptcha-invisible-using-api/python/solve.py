...
def validate_config() -> None:
    ...
    if not CAPTCHA_SITEKEY or CAPTCHA_SITEKEY == "YOUR_SITE_KEY":
        ...
        print("    Add the reCAPTCHA Invisible sitekey from your target page to .env")
        sys.exit(1)
...
def submit_task() -> str:
    ...
    print("[*] Submitting reCAPTCHA Invisible task...")
    payload = {
        "key": API_KEY,
...
def main() -> None:
    ...
    print()
    print("Next step: inject this token via the page's data-callback function")
    print("or set the g-recaptcha-response hidden field and submit the form.")
