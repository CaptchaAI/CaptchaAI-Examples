...
function validateConfig() {
  ...
  if (!CAPTCHA_SITEKEY || CAPTCHA_SITEKEY === "YOUR_SITE_KEY") {
    ...
    console.log("    Add the reCAPTCHA Invisible sitekey from your target page to .env");
    process.exit(1);
  }
...
async function submitTask() {
  console.log("[*] Submitting reCAPTCHA Invisible task...");
...
async function main() {
  ...
  console.log();
  console.log("Next step: inject this token via the page's data-callback function");
  console.log("or set the g-recaptcha-response hidden field and submit the form.");
}
